...
import {
  countRemainingToPrint,
  failStopPrintSession,
...
const generatePrintJobNumber = () => `PJ-${new Date().toISOString().slice(0, 10).replace(/-/g, "")}-${randomBytes(4).toString("hex").toUpperCase()}`;
