...
const b01WorkflowInventory = [
  ...
  { workflowId: "workflow-http-backend-src-middleware-auth-ts-require-recent-admin-mfa", entryPoint: "http:requireRecentAdminMfa", productionRoot: "backend/src/middleware/auth.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-begin-admin-totp-enrollment", entryPoint: "internal:beginAdminTotpEnrollment", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-complete-admin-mfa-challenge-boundary", entryPoint: "internal:completeAdminMfaChallengeBoundary", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-complete-admin-totp-enrollment", entryPoint: "internal:completeAdminTotpEnrollment", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-complete-admin-web-authn-authentication-boundary", entryPoint: "internal:completeAdminWebAuthnAuthenticationBoundary", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-complete-admin-web-authn-registration-boundary", entryPoint: "internal:completeAdminWebAuthnRegistrationBoundary", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-consume-admin-mfa-verifier", entryPoint: "internal:consumeAdminMfaVerifier", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-create-admin-mfa-challenge-boundary", entryPoint: "internal:createAdminMfaChallengeBoundary", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-create-admin-web-authn-challenge-boundary", entryPoint: "internal:createAdminWebAuthnChallengeBoundary", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-delete-admin-web-authn-credential-boundary", entryPoint: "internal:deleteAdminWebAuthnCredentialBoundary", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-disable-admin-mfa-boundary", entryPoint: "internal:disableAdminMfaBoundary", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-load-admin-mfa-challenge-boundary", entryPoint: "internal:loadAdminMfaChallengeBoundary", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-load-admin-mfa-state", entryPoint: "internal:loadAdminMfaState", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-load-admin-mfa-verifiers", entryPoint: "internal:loadAdminMfaVerifiers", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-load-admin-totp-enrollment", entryPoint: "internal:loadAdminTotpEnrollment", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-load-admin-web-authn-challenge-boundary", entryPoint: "internal:loadAdminWebAuthnChallengeBoundary", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-load-admin-web-authn-credentials", entryPoint: "internal:loadAdminWebAuthnCredentials", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-record-admin-mfa-challenge-failure", entryPoint: "internal:recordAdminMfaChallengeFailure", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-admin-mfa-repository-ts-replace-admin-backup-codes", entryPoint: "internal:replaceAdminBackupCodes", productionRoot: "backend/src/rls-waves/session-b/b01/adminMfaRepository.ts", boundary: "authenticated-function", localStatus },
  { workflowId: "workflow-internal-backend-src-rls-waves-session-b-b01-authenticated-security-repository-ts-load-authenticated-manufacturer-scope", entryPoint: "internal:loadAuthenticatedManufacturerScope", productionRoot: "backend/src/rls-waves/session-b/b01/authenticatedSecurityRepository.ts", boundary: "authenticated-function", localStatus },
  ...
  { workflowId: "workflow-internal-backend-src-services-auth-authenticated-session-capability-service-ts-require-authenticated-session-capability", entryPoint: "internal:requireAuthenticatedSessionCapability", productionRoot: "backend/src/services/auth/authenticatedSessionCapabilityService.ts", boundary: "authenticated-function", localStatus },
  ...
  { workflowId: "workflow-internal-backend-src-services-auth-refresh-token-service-ts-find-refresh-token-by-id", entryPoint: "internal:findRefreshTokenById", productionRoot: "backend/src/services/auth/refreshTokenService.ts", boundary: "session-credential-function", localStatus },
  ...
  { workflowId: "workflow-internal-backend-src-services-auth-session-risk-service-ts-persist-auth-session-risk", entryPoint: "internal:persistAuthSessionRisk", productionRoot: "backend/src/services/auth/sessionRiskService.ts", boundary: "authenticated-function", localStatus },
...
export const b01SessionAIntegrationRequests = [
  {
    ...
    responsePreservation: "Return the fixed repository projections; a successor remains unclaimed until explicit same-request claim, protected follow-on, and finalization release it for the next rotation; one concurrent rotation wins, an overlapping loser returns REVOKED without revoking the successor, and a later predecessor replay returns REUSE_DETECTED and revokes the family.",
