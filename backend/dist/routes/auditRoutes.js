...
router.get("/logs", auth_1.authenticate, rbac_1.requireAuditViewer, tenantIsolation_1.enforceTenantIsolation, auditController_1.getLogs);
router.get("/logs/export", auth_1.authenticate, rbac_1.requireAuditViewer, tenantIsolation_1.enforceTenantIsolation, auditController_1.exportLogsCsv);
router.get("/stream", auth_1.authenticateSSE, rbac_1.requireAuditViewer, tenantIsolation_1.enforceTenantIsolation, auditController_1.streamLogs);
