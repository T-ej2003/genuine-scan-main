...
export const printerConnectionStatusSchema = z
  .object({
    ...
    persistentSessionRequired: z.boolean().optional(),
    persistentSessionCapable: z.boolean().optional(),
    persistentSessionMinimumBuildVersion: z.string().nullable().optional(),
    persistentSessionUpdateRequired: z.boolean().optional(),
