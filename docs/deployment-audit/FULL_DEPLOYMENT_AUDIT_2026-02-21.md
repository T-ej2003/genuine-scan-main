...
- Action completed in this audit:
  - Replaced `backend/README.md` with a deployment-accurate runbook.
...
- `backend/README.md` (deployment-accurate backend runbook)
- `docs/deployment-audit/FULL_DEPLOYMENT_AUDIT_2026-02-21.md` (this report)
