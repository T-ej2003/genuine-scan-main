...
| --- | --- | --- | --- | --- | --- |
| SEC-001 | Clean-environment migration chain is broken | Critical | `backend/README.md`; migration path under `backend/prisma/migrations/` | Repair chain and prove greenfield migration in CI and pre-prod | Yes |
