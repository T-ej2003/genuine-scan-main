...
1. Open the runbook: `docs/ops/REGIONAL_FAILOVER_RUNBOOK.md`.
2. Open the record template: `docs/ops/REGIONAL_FAILOVER_TABLETOP_RECORD.md`.
3. Run:
...
Use `docs/ops/REGIONAL_FAILOVER_TABLETOP_RECORD.md` for every exercise run. Store completed records in the incident/evidence location chosen by operations, not in the repo unless the record is intentionally sanitized for internal documentation.
