...
export function LegalDocumentLayout({ title, summary, updatedAt, version, children }: LegalDocumentLayoutProps) {
  return (
        ...
        <div className="mx-auto flex w-full max-w-5xl items-center justify-between gap-4 px-4 py-4">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-slate-500">Legal and privacy information</div>
            </div>
          </Link>
          <div className="text-xs uppercase tracking-[0.18em] text-slate-500">Public notice</div>
        </div>
      </header>
