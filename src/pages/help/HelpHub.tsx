...
const SCREENSHOTS: ScreenshotNeed[] = [
  ...
  { filename: "licensee-request-qr-inventory.png", whereToCapture: "Licensee Admin Code Requests page with quantity filled and Send request highlighted.", usedIn: "Licensee/Admin" },
  ...
  { filename: "customer-first-verification.png", whereToCapture: "Public verify page showing MSCQR confirmed this label.", usedIn: "Customer" },
  { filename: "customer-verified-again.png", whereToCapture: "Public verify page showing MSCQR confirmed this code again.", usedIn: "Customer" },
  { filename: "customer-possible-duplicate.png", whereToCapture: "Public verify page showing Review required with verification notes.", usedIn: "Customer" },
