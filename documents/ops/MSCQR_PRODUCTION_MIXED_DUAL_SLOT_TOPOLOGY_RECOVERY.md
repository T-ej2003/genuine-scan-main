...
non-contiguous or altered state is rejected. At 7/7, replay is classified as
complete and performs no mutation. The bootstrap accepts T1 because no slot has
an `AWSCURRENT` value; it still generates and writes all fresh source-bound T2
