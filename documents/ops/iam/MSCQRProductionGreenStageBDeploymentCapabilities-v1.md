...
| 21 | existing-revision-forward-recovery | `scripts/aws/forward-recover-stage-b-existing-revision.mjs` |
| 22 | stage-b-state-pull | `scripts/aws/run-production-green-stage-b-preflight.mjs` |
| 23 | stage-a-state-read | `scripts/aws/run-production-green-stage-b-preflight.mjs` |
| 24 | stage-a-handoff-generation | `scripts/aws/generate-production-green-stage-a-prerequisites.mjs` |
| 25 | root-drop-evidence-signing | `scripts/aws/produce-production-root-drop-evidence.mjs` |
| 26 | tfvars-generation | `scripts/aws/generate-production-green-stage-b-tfvars.mjs` |
| 27 | refresh-only | `scripts/refresh-production-green-stage-b.mjs` |
| 28 | saved-plan-generation | `scripts/plan-production-green-stage-b.mjs` |
| 29 | plan-json-canonicalization | `scripts/plan-production-green-stage-b.mjs` |
| 30 | reference-audit | `scripts/aws/generate-production-green-stage-b-reference-audit.mjs` |
| 31 | plan-bound-permission-report | `scripts/aws/validate-production-green-stage-b-permissions.mjs` |
| 32 | production-closure | `scripts/aws/validate-stage-b-deployment-closure.mjs` |
| 33 | validator | `scripts/plan-production-green-stage-b.mjs` |
| 34 | wrapper-verify-only | `scripts/apply-production-green-stage-b.mjs` |
| 35 | wrapper-apply | `scripts/apply-production-green-stage-b.mjs` |
| 36 | post-apply-verification | `scripts/aws/verify-production-green-stage-b-ecs-observations.mjs` |
| 37 | runtime-activation-boundary | `scripts/aws/create-production-green-stage-b-approval.mjs` |
| 38 | normal-backend-activation | `scripts/aws/production-normal-backend-activation.mjs` |
