...
- CloudWatch metric filters applied from `documents/observability/cloudwatch/verification-trust-metric-filters.json`
- CloudWatch alarms applied from `documents/observability/cloudwatch/verification-trust-alarms.json`
- Test-fire proof for:
  - replay spike alert
