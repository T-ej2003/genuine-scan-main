...
- `backend/.env.example`
- `README.md`
- `documents/aws/object-storage-task-role.md`
...
- ECS image architecture and ECR publishing are handled separately. Use [documents/aws/chatgpt-handoff-ecs-image-architecture.md](/Users/abhiramteja/Downloads/genuine-scan-main/documents/aws/chatgpt-handoff-ecs-image-architecture.md:1) for buildx publishing, manifest verification, and task-definition image update steps.
