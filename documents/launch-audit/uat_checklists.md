...
Repo evidence used included `src/App.tsx`, `backend/src/routes/index.ts`, role guides under `documents/`, public verification components, support flows, and route guards.
