...
ALTER TABLE "QrScanLog" NO FORCE ROW LEVEL SECURITY;
...
ALTER TABLE "TenantFeatureFlag" NO FORCE ROW LEVEL SECURITY;
ALTER TABLE "TenantFeatureFlag" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "VerificationDecision" NO FORCE ROW LEVEL SECURITY;
ALTER TABLE "VerificationDecision" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "PrintReissueRequest" NO FORCE ROW LEVEL SECURITY;
ALTER TABLE "PrintReissueRequest" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "BatchPrintPackToken" NO FORCE ROW LEVEL SECURITY;
ALTER TABLE "BatchPrintPackToken" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "CustomerVerificationSession" NO FORCE ROW LEVEL SECURITY;
ALTER TABLE "CustomerVerificationSession" DISABLE ROW LEVEL SECURITY;
ALTER TABLE "SupportTicket" NO FORCE ROW LEVEL SECURITY;
