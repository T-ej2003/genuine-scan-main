...
| worker-boundary-scheduled-compliance-packs | scheduled-maintenance-job | identity-scheduled-job | table-compliance-pack-job plus a durable schedule-run key; each tenant partition is claimed before report generation | table-licensee, table-compliance-pack-job, table-action-idempotency-key, table-incident, table-incident-handoff, table-audit-log, table-evidence-retention-policy | table-compliance-pack-job, table-action-idempotency-key, table-audit-log-outbox | worker-fn-claim-compliance-pack-slice |
