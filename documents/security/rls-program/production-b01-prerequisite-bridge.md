...
This bridge preserves three identities. `0f7ae1a70eec588ef4fdcb2b53e9f42e831c4414` is the immutable origin of the reviewed #567 RLS delta. `e1c16977e9fdce7a19dc267ba3c816ef4ff14597` is the reviewed #568 bridge merge. The deployment source is the exact protected-main merge SHA of the narrow live-predecessor correction that immediately follows it. Executable diff attestations cover both ranges and reject application, authentication, RLS, schema, MFA, session, invitation, business, or unclassified changes.
