...
| MfaLoginChallenge | security-sensitive | Special repository/function boundary with row scope inherited from User through userId=id. | table-user | yes | identity-pre-auth-app | identity-authenticated-app, identity-pre-auth-app | high | none |
