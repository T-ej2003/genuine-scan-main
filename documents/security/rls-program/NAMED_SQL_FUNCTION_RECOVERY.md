...
| `app_rls.batch_operational_total` | no definition found | none | none | no |
| `app_rls.batch_reservable_qr_summaries` | no definition found | none | none | no |
| `app_rls.batch_status_fallback` | no definition found | none | none | no |
| `app_rls.batch_unassigned_ranges` | no definition found | none | none | no |
...
| `app_rls.c03_complete_compliance_pack_job` | no definition found | none | none | no |
| `app_rls.c03_complete_compliance_pack_rebuild` | no definition found | none | none | no |
...
| `app_rls.c03_fail_compliance_pack_job` | no definition found | none | none | no |
...
| `app_rls.c03_get_compliance_pack_job` | no definition found | none | none | no |
| `app_rls.c03_get_incident_detail` | no definition found | none | none | no |
| `app_rls.c03_get_incident_evidence_file_by_storage_key` | no definition found | none | none | no |
...
| `app_rls.c03_revalidate_actor_scope` | production definition recovered | backend/src/rls-waves/session-c/c03/c03Boundary.sql | fb555a0315ba | yes |
| `app_rls.c03_revalidate_compliance_pack_job_actor_scope` | production definition recovered | backend/src/rls-waves/session-c/c03/c03Boundary.sql | d4edf6e4a63e | yes |
| `app_rls.c03_revalidate_incident_actor_scope` | production definition recovered | backend/src/rls-waves/session-c/c03/c03Boundary.sql | d4edf6e4a63e | yes |
| `app_rls.c03_revalidate_incident_evidence_actor_scope` | production definition recovered | backend/src/rls-waves/session-c/c03/c03Boundary.sql | 3011e341c723 | yes |
| `app_rls.c03_revalidate_incident_evidence_storage_actor_scope` | production definition recovered | backend/src/rls-waves/session-c/c03/c03Boundary.sql | 3011e341c723 | yes |
| `app_rls.c03_revalidate_platform_actor_scope` | production definition recovered | backend/src/rls-waves/session-c/c03/c03Boundary.sql | d4edf6e4a63e | yes |
| `app_rls.c03_revalidate_policy_rule_actor_scope` | production definition recovered | backend/src/rls-waves/session-c/c03/c03Boundary.sql | d4edf6e4a63e | yes |
| `app_rls.c03_revalidate_sensitive_approval_actor_scope` | production definition recovered | backend/src/rls-waves/session-c/c03/c03Boundary.sql | 3011e341c723 | yes |
...
| `app_rls.c03_start_compliance_pack_job` | no definition found | none | none | no |
...
| `app_rls.dashboard_snapshot_data` | no definition found | none | none | no |
| `app_rls.dashboard_snapshot_scope` | no definition found | none | none | no |
...
| `app_rls.platform_audit_log_details` | production definition recovered | backend/src/rls-waves/session-c/c02/auditTrace.sql | cc14d113f577 | yes |
