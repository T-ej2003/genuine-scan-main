...
console.log(JSON.stringify({
  ...
  contextBoundariesImplemented: workflows.workflows.filter((workflow) => workflow.contextBoundaryStatus === "implemented").length,
  postgresqlCertificationsPending: workflows.workflows.filter((workflow) => workflow.contextBoundaryStatus === "implemented" && workflow.postgresqlCertificationStatus !== "certified").length,
  directPrismaCallersRemaining: workflows.workflows.filter((workflow) => workflow.contextBoundaryStatus !== "implemented").reduce((total, workflow) => total + workflow.currentDirectPrismaUsage.length, 0),
