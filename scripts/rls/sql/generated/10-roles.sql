...
COMMENT ON ROLE "mscqr_rls_cert_owner" IS 'mscqr-full-rls-clean-room:certification:0825b3e5d42aaa5f78b1ed3b506e70c6808bd1a45bc5340df70ee5f69be5ec4c';
GRANT "mscqr_rls_cert_auth_owner" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_auth_owner" IS 'mscqr-full-rls-clean-room:certification:0825b3e5d42aaa5f78b1ed3b506e70c6808bd1a45bc5340df70ee5f69be5ec4c';
GRANT "mscqr_rls_cert_app" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_app" IS 'mscqr-full-rls-clean-room:certification:0825b3e5d42aaa5f78b1ed3b506e70c6808bd1a45bc5340df70ee5f69be5ec4c';
GRANT "mscqr_rls_cert_read" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_read" IS 'mscqr-full-rls-clean-room:certification:0825b3e5d42aaa5f78b1ed3b506e70c6808bd1a45bc5340df70ee5f69be5ec4c';
GRANT "mscqr_rls_cert_preauth" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_preauth" IS 'mscqr-full-rls-clean-room:certification:0825b3e5d42aaa5f78b1ed3b506e70c6808bd1a45bc5340df70ee5f69be5ec4c';
GRANT "mscqr_rls_cert_worker" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_worker" IS 'mscqr-full-rls-clean-room:certification:0825b3e5d42aaa5f78b1ed3b506e70c6808bd1a45bc5340df70ee5f69be5ec4c';
GRANT "mscqr_rls_cert_scheduled" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_scheduled" IS 'mscqr-full-rls-clean-room:certification:0825b3e5d42aaa5f78b1ed3b506e70c6808bd1a45bc5340df70ee5f69be5ec4c';
GRANT "mscqr_rls_cert_operator" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_operator" IS 'mscqr-full-rls-clean-room:certification:0825b3e5d42aaa5f78b1ed3b506e70c6808bd1a45bc5340df70ee5f69be5ec4c';
GRANT "mscqr_rls_cert_migration" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_migration" IS 'mscqr-full-rls-clean-room:certification:0825b3e5d42aaa5f78b1ed3b506e70c6808bd1a45bc5340df70ee5f69be5ec4c';
...
VALUES (
  'certification','cert',current_database(),'0825b3e5d42aaa5f78b1ed3b506e70c6808bd1a45bc5340df70ee5f69be5ec4c','mscqr-full-rls-clean-room:certification:0825b3e5d42aaa5f78b1ed3b506e70c6808bd1a45bc5340df70ee5f69be5ec4c',current_user,
  NULL,
  NULL,
  NULL,
  NULL,
