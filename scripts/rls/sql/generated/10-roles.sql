...
COMMENT ON ROLE "mscqr_rls_cert_owner" IS 'mscqr-full-rls-clean-room:certification:bfd15dab7d63b2358523ae016bb90073ded228f60af99999527fe416819b89bf';
GRANT "mscqr_rls_cert_auth_owner" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_auth_owner" IS 'mscqr-full-rls-clean-room:certification:bfd15dab7d63b2358523ae016bb90073ded228f60af99999527fe416819b89bf';
GRANT "mscqr_rls_cert_app" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_app" IS 'mscqr-full-rls-clean-room:certification:bfd15dab7d63b2358523ae016bb90073ded228f60af99999527fe416819b89bf';
GRANT "mscqr_rls_cert_read" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_read" IS 'mscqr-full-rls-clean-room:certification:bfd15dab7d63b2358523ae016bb90073ded228f60af99999527fe416819b89bf';
GRANT "mscqr_rls_cert_preauth" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_preauth" IS 'mscqr-full-rls-clean-room:certification:bfd15dab7d63b2358523ae016bb90073ded228f60af99999527fe416819b89bf';
GRANT "mscqr_rls_cert_worker" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_worker" IS 'mscqr-full-rls-clean-room:certification:bfd15dab7d63b2358523ae016bb90073ded228f60af99999527fe416819b89bf';
GRANT "mscqr_rls_cert_scheduled" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_scheduled" IS 'mscqr-full-rls-clean-room:certification:bfd15dab7d63b2358523ae016bb90073ded228f60af99999527fe416819b89bf';
GRANT "mscqr_rls_cert_operator" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_operator" IS 'mscqr-full-rls-clean-room:certification:bfd15dab7d63b2358523ae016bb90073ded228f60af99999527fe416819b89bf';
GRANT "mscqr_rls_cert_migration" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_migration" IS 'mscqr-full-rls-clean-room:certification:bfd15dab7d63b2358523ae016bb90073ded228f60af99999527fe416819b89bf';
...
VALUES (
  'certification','cert',current_database(),'bfd15dab7d63b2358523ae016bb90073ded228f60af99999527fe416819b89bf','mscqr-full-rls-clean-room:certification:bfd15dab7d63b2358523ae016bb90073ded228f60af99999527fe416819b89bf',current_user,
  NULL,
  NULL,
  NULL,
  NULL,
