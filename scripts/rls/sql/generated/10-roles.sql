...
COMMENT ON ROLE "mscqr_rls_cert_owner" IS 'mscqr-full-rls-clean-room:certification:75b844efc48d1c57ba983cd097df7de8fdef5e22db259c4f44dd999fe9209416';
GRANT "mscqr_rls_cert_auth_owner" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_auth_owner" IS 'mscqr-full-rls-clean-room:certification:75b844efc48d1c57ba983cd097df7de8fdef5e22db259c4f44dd999fe9209416';
GRANT "mscqr_rls_cert_app" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_app" IS 'mscqr-full-rls-clean-room:certification:75b844efc48d1c57ba983cd097df7de8fdef5e22db259c4f44dd999fe9209416';
GRANT "mscqr_rls_cert_read" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_read" IS 'mscqr-full-rls-clean-room:certification:75b844efc48d1c57ba983cd097df7de8fdef5e22db259c4f44dd999fe9209416';
GRANT "mscqr_rls_cert_preauth" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_preauth" IS 'mscqr-full-rls-clean-room:certification:75b844efc48d1c57ba983cd097df7de8fdef5e22db259c4f44dd999fe9209416';
GRANT "mscqr_rls_cert_worker" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_worker" IS 'mscqr-full-rls-clean-room:certification:75b844efc48d1c57ba983cd097df7de8fdef5e22db259c4f44dd999fe9209416';
GRANT "mscqr_rls_cert_scheduled" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_scheduled" IS 'mscqr-full-rls-clean-room:certification:75b844efc48d1c57ba983cd097df7de8fdef5e22db259c4f44dd999fe9209416';
GRANT "mscqr_rls_cert_operator" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_operator" IS 'mscqr-full-rls-clean-room:certification:75b844efc48d1c57ba983cd097df7de8fdef5e22db259c4f44dd999fe9209416';
GRANT "mscqr_rls_cert_migration" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_migration" IS 'mscqr-full-rls-clean-room:certification:75b844efc48d1c57ba983cd097df7de8fdef5e22db259c4f44dd999fe9209416';
...
VALUES (
  'certification','cert',current_database(),'75b844efc48d1c57ba983cd097df7de8fdef5e22db259c4f44dd999fe9209416','mscqr-full-rls-clean-room:certification:75b844efc48d1c57ba983cd097df7de8fdef5e22db259c4f44dd999fe9209416',current_user,
  NULL,
  NULL,
  NULL,
  NULL,
