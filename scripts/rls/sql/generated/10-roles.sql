...
COMMENT ON ROLE "mscqr_rls_cert_owner" IS 'mscqr-full-rls-clean-room:certification:303b2b922c05946a710bd5e362a616c94838a341649fd30192555df92f1dcf4a';
GRANT "mscqr_rls_cert_auth_owner" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_auth_owner" IS 'mscqr-full-rls-clean-room:certification:303b2b922c05946a710bd5e362a616c94838a341649fd30192555df92f1dcf4a';
GRANT "mscqr_rls_cert_app" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_app" IS 'mscqr-full-rls-clean-room:certification:303b2b922c05946a710bd5e362a616c94838a341649fd30192555df92f1dcf4a';
GRANT "mscqr_rls_cert_read" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_read" IS 'mscqr-full-rls-clean-room:certification:303b2b922c05946a710bd5e362a616c94838a341649fd30192555df92f1dcf4a';
GRANT "mscqr_rls_cert_preauth" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_preauth" IS 'mscqr-full-rls-clean-room:certification:303b2b922c05946a710bd5e362a616c94838a341649fd30192555df92f1dcf4a';
GRANT "mscqr_rls_cert_worker" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_worker" IS 'mscqr-full-rls-clean-room:certification:303b2b922c05946a710bd5e362a616c94838a341649fd30192555df92f1dcf4a';
GRANT "mscqr_rls_cert_scheduled" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_scheduled" IS 'mscqr-full-rls-clean-room:certification:303b2b922c05946a710bd5e362a616c94838a341649fd30192555df92f1dcf4a';
GRANT "mscqr_rls_cert_operator" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_operator" IS 'mscqr-full-rls-clean-room:certification:303b2b922c05946a710bd5e362a616c94838a341649fd30192555df92f1dcf4a';
GRANT "mscqr_rls_cert_migration" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_migration" IS 'mscqr-full-rls-clean-room:certification:303b2b922c05946a710bd5e362a616c94838a341649fd30192555df92f1dcf4a';
...
VALUES (
  'certification','cert',current_database(),'303b2b922c05946a710bd5e362a616c94838a341649fd30192555df92f1dcf4a','mscqr-full-rls-clean-room:certification:303b2b922c05946a710bd5e362a616c94838a341649fd30192555df92f1dcf4a',current_user,
  NULL,
  NULL,
  NULL,
  NULL,
