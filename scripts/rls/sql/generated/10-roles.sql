...
COMMENT ON ROLE "mscqr_rls_cert_owner" IS 'mscqr-full-rls-clean-room:certification:1d12c063a728c724b90a7bacd30c5d2a225dd8897360f466d660b2d1d24c4c66';
GRANT "mscqr_rls_cert_auth_owner" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_auth_owner" IS 'mscqr-full-rls-clean-room:certification:1d12c063a728c724b90a7bacd30c5d2a225dd8897360f466d660b2d1d24c4c66';
GRANT "mscqr_rls_cert_app" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_app" IS 'mscqr-full-rls-clean-room:certification:1d12c063a728c724b90a7bacd30c5d2a225dd8897360f466d660b2d1d24c4c66';
GRANT "mscqr_rls_cert_read" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_read" IS 'mscqr-full-rls-clean-room:certification:1d12c063a728c724b90a7bacd30c5d2a225dd8897360f466d660b2d1d24c4c66';
GRANT "mscqr_rls_cert_preauth" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_preauth" IS 'mscqr-full-rls-clean-room:certification:1d12c063a728c724b90a7bacd30c5d2a225dd8897360f466d660b2d1d24c4c66';
GRANT "mscqr_rls_cert_worker" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_worker" IS 'mscqr-full-rls-clean-room:certification:1d12c063a728c724b90a7bacd30c5d2a225dd8897360f466d660b2d1d24c4c66';
GRANT "mscqr_rls_cert_scheduled" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_scheduled" IS 'mscqr-full-rls-clean-room:certification:1d12c063a728c724b90a7bacd30c5d2a225dd8897360f466d660b2d1d24c4c66';
GRANT "mscqr_rls_cert_operator" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_operator" IS 'mscqr-full-rls-clean-room:certification:1d12c063a728c724b90a7bacd30c5d2a225dd8897360f466d660b2d1d24c4c66';
GRANT "mscqr_rls_cert_migration" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_migration" IS 'mscqr-full-rls-clean-room:certification:1d12c063a728c724b90a7bacd30c5d2a225dd8897360f466d660b2d1d24c4c66';
...
VALUES (
  'certification','cert',current_database(),'1d12c063a728c724b90a7bacd30c5d2a225dd8897360f466d660b2d1d24c4c66','mscqr-full-rls-clean-room:certification:1d12c063a728c724b90a7bacd30c5d2a225dd8897360f466d660b2d1d24c4c66',current_user,
  NULL,
  NULL,
  NULL,
  NULL,
