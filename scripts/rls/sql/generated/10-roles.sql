...
COMMENT ON ROLE "mscqr_rls_cert_owner" IS 'mscqr-full-rls-clean-room:certification:5717f4e3e39bb9b77c2994f0b67f97489046a0ceda84728893e30800fdab150d';
GRANT "mscqr_rls_cert_auth_owner" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_auth_owner" IS 'mscqr-full-rls-clean-room:certification:5717f4e3e39bb9b77c2994f0b67f97489046a0ceda84728893e30800fdab150d';
GRANT "mscqr_rls_cert_app" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_app" IS 'mscqr-full-rls-clean-room:certification:5717f4e3e39bb9b77c2994f0b67f97489046a0ceda84728893e30800fdab150d';
GRANT "mscqr_rls_cert_read" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_read" IS 'mscqr-full-rls-clean-room:certification:5717f4e3e39bb9b77c2994f0b67f97489046a0ceda84728893e30800fdab150d';
GRANT "mscqr_rls_cert_preauth" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_preauth" IS 'mscqr-full-rls-clean-room:certification:5717f4e3e39bb9b77c2994f0b67f97489046a0ceda84728893e30800fdab150d';
GRANT "mscqr_rls_cert_worker" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_worker" IS 'mscqr-full-rls-clean-room:certification:5717f4e3e39bb9b77c2994f0b67f97489046a0ceda84728893e30800fdab150d';
GRANT "mscqr_rls_cert_scheduled" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_scheduled" IS 'mscqr-full-rls-clean-room:certification:5717f4e3e39bb9b77c2994f0b67f97489046a0ceda84728893e30800fdab150d';
GRANT "mscqr_rls_cert_operator" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_operator" IS 'mscqr-full-rls-clean-room:certification:5717f4e3e39bb9b77c2994f0b67f97489046a0ceda84728893e30800fdab150d';
GRANT "mscqr_rls_cert_migration" TO "certification-administrator" WITH ADMIN FALSE, INHERIT FALSE, SET TRUE;
COMMENT ON ROLE "mscqr_rls_cert_migration" IS 'mscqr-full-rls-clean-room:certification:5717f4e3e39bb9b77c2994f0b67f97489046a0ceda84728893e30800fdab150d';
...
VALUES (
  'certification','cert',current_database(),'5717f4e3e39bb9b77c2994f0b67f97489046a0ceda84728893e30800fdab150d','mscqr-full-rls-clean-room:certification:5717f4e3e39bb9b77c2994f0b67f97489046a0ceda84728893e30800fdab150d',current_user,
  NULL,
  NULL,
  NULL,
  NULL,
