...
BEGIN
  IF current_setting('app.context_installed', true) IS DISTINCT FROM '1'
     ...
     OR (login_role <> 'mscqr_rls_cert_operator' AND login_role <> 'mscqr_rls_wave_c_operator') THEN
    RAISE EXCEPTION 'SESSION_C04_INVALID_CONTEXT';
  END IF;
END;
$$;
...
GRANT USAGE ON SCHEMA app_ops TO "mscqr_rls_cert_operator";
GRANT EXECUTE ON FUNCTION app_ops.diagnose_account_onboarding(text) TO "mscqr_rls_cert_operator";
RESET ROLE;
