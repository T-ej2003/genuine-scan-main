...
const b03AuthenticatedSecurity = Object.freeze({
  ...
  ownerPrivileges:[
    ...
    ["Incident","SELECT",["id","qrCodeId","qrCodeValue","scanEventId","licenseeId","severity","status","createdAt"]],
    ...
    ["SupportTicket","SELECT",["id","licenseeId","referenceCode","status","priority","updatedAt"]],
  ...
  ownerPolicies:[
    ...
    ["Incident","SELECT",`(${b03AuthenticatedBinding} AND (id=current_setting('app.b03_incident_id',true) OR "licenseeId"=current_setting('app.b03_licensee_id',true))) OR (${b03AttentionRead} AND ${b03AttentionTenantScope})`],
    ...
    ["SupportTicket","SELECT",`${b03AttentionRead} AND ${b03AttentionRole} IN ('SUPER_ADMIN','PLATFORM_SUPER_ADMIN') AND (${b03AttentionLicensee}='' OR "licenseeId"=${b03AttentionLicensee})`],
