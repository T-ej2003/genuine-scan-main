...
function assertAuthenticatedSources(authenticated, { sourceSha, expectedStageBLineage, expectedStageBSerial, expectedIngress } = {}) {
  ...
  return { stageAStateSha256: hash(stageAState.bytes), stageAHandoffSha256: hash(stageAHandoff.bytes), stageBStateSha256: hash(stageBState.bytes), ingress, stageAContract };
}
