...
case "$operation" in
  ...
  attest)
    ...
    case "$attestation_type" in
      spdxjson|https://mscqr.com/attestations/stage-b-provenance/v1|https://mscqr.com/attestations/production-web-provenance/v1|https://mscqr.com/attestations/normal-production-provenance/v1) ;;
      *) echo "Unsupported production attestation type." >&2; exit 2 ;;
    esac
