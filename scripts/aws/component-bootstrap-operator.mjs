...
export async function authenticateBootstrapOperator(binding, { issuanceEvents, load = loadBootstrapOperatorSource, sts = transport,
  ...
  assert(["IDENTITY_BOOTSTRAP", "BROKER_CHANGE", "BROKER_POLICY_SUCCESSOR", "BROKER_RECOVERY_SUCCESSOR"].includes(binding.purpose), "Unsupported exceptional operator purpose"); sessionProofBinding(binding);
