...
import { LEGACY_BOOTSTRAP_TRANSITION_SECRET_READ_RESOURCES } from "./production-bootstrap-operator-policy-reconciliation.mjs";
...
const CALLS = Object.freeze([
  ...
  ["scripts/aws/generate-production-green-stage-a-prerequisites.mjs", "cloudfront:ListDistributions", "stage-b-state-reconciliation-producer-collect-stage-a-live-cloudfront-distribution", ["*"]],
  ["scripts/aws/generate-production-green-stage-a-prerequisites.mjs", "cloudfront:GetDistributionConfig", "stage-b-state-reconciliation-producer-collect-stage-a-live-cloudfront-distribution-config", ["*"]],
  ["scripts/aws/generate-production-green-stage-a-prerequisites.mjs", "route53:ListResourceRecordSets", "stage-b-state-reconciliation-producer-collect-stage-a-live-route53-production-aliases", ["*"]],
  ...
  ["scripts/aws/recover-production-mixed-dual-slot-topology.mjs", "secretsmanager:UpdateSecretVersionStage", "mixed-recovery-move-awscurrent", MIXED_DUAL_SLOT_RECOVERY_IAM_RESOURCES, "MIXED_RECOVERY_EXECUTOR"],
  ...
  ["scripts/aws/run-production-initial-activation-lifecycle-policy-reconciliation.mjs", "sts:GetCallerIdentity", "initial-activation-policy-reconciliation-root-identify", ["*"], "INITIAL_ACTIVATION_RECONCILER"],
  ["scripts/aws/run-production-initial-activation-lifecycle-policy-reconciliation.mjs", "iam:GetPolicy", "initial-activation-policy-reconciliation-root-read-policy", ["arn:aws:iam::368992683803:policy/MSCQRProductionInitialActivationLifecycle"], "INITIAL_ACTIVATION_RECONCILER"],
  ["scripts/aws/run-production-initial-activation-lifecycle-policy-reconciliation.mjs", "iam:GetPolicyVersion", "initial-activation-policy-reconciliation-root-read-policy-version", ["arn:aws:iam::368992683803:policy/MSCQRProductionInitialActivationLifecycle"], "INITIAL_ACTIVATION_RECONCILER"],
  ["scripts/aws/run-production-initial-activation-lifecycle-policy-reconciliation.mjs", "iam:ListPolicyVersions", "initial-activation-policy-reconciliation-root-list-policy-versions", ["arn:aws:iam::368992683803:policy/MSCQRProductionInitialActivationLifecycle"], "INITIAL_ACTIVATION_RECONCILER"],
  ["scripts/aws/run-production-initial-activation-lifecycle-policy-reconciliation.mjs", "iam:GetRole", "initial-activation-policy-reconciliation-root-read-release-role", ["arn:aws:iam::368992683803:role/mscqr-production-release-deployer"], "INITIAL_ACTIVATION_RECONCILER"],
  ...
  ["scripts/aws/reconcile-production-provider-readonly-policy.mjs", "s3:ListBucket", "provider-readonly-reconciliation-list-journal-absence", [PRODUCTION_ARTIFACTS_BUCKET], "INITIAL_ACTIVATION_RECONCILER"],
  ...
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "sts:GetCallerIdentity", "bootstrap-operator-policy-reconciliation-identify", ["*"], "ROOT_OPERATOR"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "sts:GetCallerIdentity", "bootstrap-operator-policy-authorization-identify", ["*"], "BOOTSTRAP_OPERATOR_POLICY_AUTHORIZER"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "iam:GetUser", "bootstrap-operator-policy-reconciliation-read-user", [BOOTSTRAP_OPERATOR_USER], "ROOT_OPERATOR"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "iam:ListAttachedUserPolicies", "bootstrap-operator-policy-reconciliation-list-attached", [BOOTSTRAP_OPERATOR_USER], "ROOT_OPERATOR"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "iam:ListUserPolicies", "bootstrap-operator-policy-reconciliation-list-inline", [BOOTSTRAP_OPERATOR_USER], "ROOT_OPERATOR"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "iam:ListGroupsForUser", "bootstrap-operator-policy-reconciliation-list-groups", [BOOTSTRAP_OPERATOR_USER], "ROOT_OPERATOR"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "iam:ListAccessKeys", "bootstrap-operator-policy-reconciliation-list-access-keys", [BOOTSTRAP_OPERATOR_USER], "ROOT_OPERATOR"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "iam:ListMFADevices", "bootstrap-operator-policy-reconciliation-list-mfa-devices", [BOOTSTRAP_OPERATOR_USER], "ROOT_OPERATOR"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "iam:GetLoginProfile", "bootstrap-operator-policy-reconciliation-read-login-profile", [BOOTSTRAP_OPERATOR_USER], "ROOT_OPERATOR"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "iam:GetUserPolicy", "bootstrap-operator-policy-reconciliation-read-inline", [BOOTSTRAP_OPERATOR_USER], "ROOT_OPERATOR"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "iam:ListUserTags", "bootstrap-operator-policy-reconciliation-read-transition-consumption", [BOOTSTRAP_OPERATOR_USER], "ROOT_OPERATOR", "readLegacyTransitionConsumption"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "iam:ListUserTags", "bootstrap-operator-policy-authorization-read-transition-consumption", [BOOTSTRAP_OPERATOR_USER], "BOOTSTRAP_OPERATOR_POLICY_AUTHORIZER", "readLegacyTransitionConsumption"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "secretsmanager:DescribeSecret", "bootstrap-operator-policy-reconciliation-read-initial-overlap-secrets", LEGACY_BOOTSTRAP_TRANSITION_SECRET_READ_RESOURCES, "ROOT_OPERATOR", "verifyLiveInitialDualSlotBindingWithRunner"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "secretsmanager:GetSecretValue", "bootstrap-operator-policy-reconciliation-read-initial-overlap-values", LEGACY_BOOTSTRAP_TRANSITION_SECRET_READ_RESOURCES, "ROOT_OPERATOR", "verifyLiveInitialDualSlotBindingWithRunner"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "secretsmanager:DescribeSecret", "bootstrap-operator-policy-authorization-read-initial-overlap-secrets", LEGACY_BOOTSTRAP_TRANSITION_SECRET_READ_RESOURCES, "BOOTSTRAP_OPERATOR_POLICY_AUTHORIZER", "verifyLiveInitialDualSlotBindingWithRunner"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "secretsmanager:GetSecretValue", "bootstrap-operator-policy-authorization-read-initial-overlap-values", LEGACY_BOOTSTRAP_TRANSITION_SECRET_READ_RESOURCES, "BOOTSTRAP_OPERATOR_POLICY_AUTHORIZER", "verifyLiveInitialDualSlotBindingWithRunner"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "iam:PutUserPolicy", "bootstrap-operator-policy-reconciliation-write-inline", [BOOTSTRAP_OPERATOR_USER], "ROOT_OPERATOR"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "iam:TagUser", "bootstrap-operator-policy-reconciliation-consume-transition", [BOOTSTRAP_OPERATOR_USER], "ROOT_OPERATOR"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "s3:GetObject", "bootstrap-operator-policy-reconciliation-read-reservation", [`arn:aws:s3:::mscqr-prod-euw2-artifacts-368992683803-eu-west-2-an/production-initial-activation-lifecycle-policy-reconciliation/reservations/bootstrap-operator-legacy-mfa-transition.json`], "ROOT_OPERATOR"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "s3:PutObject", "bootstrap-operator-policy-reconciliation-create-reservation", [`arn:aws:s3:::mscqr-prod-euw2-artifacts-368992683803-eu-west-2-an/production-initial-activation-lifecycle-policy-reconciliation/reservations/bootstrap-operator-legacy-mfa-transition.json`], "ROOT_OPERATOR"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "s3:PutObject", "bootstrap-operator-policy-reconciliation-replace-expired-reservation", [`arn:aws:s3:::mscqr-prod-euw2-artifacts-368992683803-eu-west-2-an/production-initial-activation-lifecycle-policy-reconciliation/reservations/bootstrap-operator-legacy-mfa-transition.json`], "ROOT_OPERATOR"],
...
const BOOTSTRAP_OPERATOR_POLICY_RECONCILIATION_MODE = "BOOTSTRAP_OPERATOR_POLICY_RECONCILIATION";
...
const STAGE_A_CAPABILITY_MODES = Object.freeze({
  ...
  "stage-a-artifacts-recovery-root-journal-list-absence": [STAGE_A_RECOVERY_MODE],
  ...
  "stage-a-artifacts-journal-list-absence": [STAGE_A_RECOVERY_MODE, STAGE_A_RECONCILIATION_MODE],
...
export function buildProductionDependencyClosure() {
  ...
  const expectedInputs = ["backend_recovery_current_task_definition_arn", "backend_recovery_evidence_bundle_gzip_base64", "backend_recovery_evidence_bundle_sha256", "backend_recovery_image_digest"];
  ...
  requireTokens("scripts/aws/dispatch-production-backend-health-recovery.mjs", ["ROLLBACK_APPROVAL_FIELDS", "BACKEND_HEALTH_RECOVERY_DISPATCH_BUNDLE", "backend_recovery_evidence_bundle_gzip_base64", "backend_recovery_evidence_bundle_sha256", "MAX_DECOMPRESSED_BUNDLE_BYTES", "inflateRawSync", "bytesWritten", "maxOutputLength"]);
  ...
  return {
    ...
    runtimeModeClosure: {
      ...
      BOOTSTRAP_OPERATOR_POLICY_RECONCILIATION: "root readback and protected authorization permit one exact MFA-gated verifier-role AssumeRole addition to the bootstrap user's sole inline policy; no verifier operational permission is granted directly",
...
export function assertChangedAwsCallClosure(scanned, graph) {
  ...
  const normalized = scanned.map(({ sourceFile, action, identity, sourceFunction, capabilityId }) => {
    const sourceBound = capabilityId?.endsWith("-read-raw-state") || capabilityId?.includes("reservation");
    return identityBound(sourceFile) ? { sourceFile, action, identity, ...(sourceBound ? { sourceFunction, capabilityId } : {}) } : { sourceFile, action, ...(sourceBound ? { sourceFunction, capabilityId } : {}) };
  });
  ...
  return [...appOnly, ...CALLS.map((contract) => {
    ...
    const reachableMode = stageAModes
      ...
      : contract.sourceFile.endsWith("run-production-initial-activation-lifecycle-policy-reconciliation.mjs") || contract.sourceFile.endsWith("production-initial-activation-policy-reconciliation.mjs") ? [INITIAL_ACTIVATION_POLICY_RECONCILIATION_MODE]
