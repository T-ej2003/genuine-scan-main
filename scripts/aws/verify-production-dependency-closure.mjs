...
const MODE_CAPABILITIES = Object.freeze({
  ...
  STAGE_A_PRODUCTION_ARTIFACTS_STATE_RECONCILIATION: ["stage-a-artifacts-reconciliation-release-identify", "stage-a-artifacts-reconciliation-release-read-policy", "stage-a-artifacts-journal-read", "stage-a-artifacts-journal-conditional-create", "release-root-attestation-verify", "release-root-attestation-describe-key", "release-root-attestation-read-key-policy", "release-root-attestation-read-key-tags"],
