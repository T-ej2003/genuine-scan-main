...
export function buildProductionDependencyClosure() {
  ...
  requireTokens("scripts/aws/prepare-production-backend-failed-recovery-evidence.mjs", ["PRE_RUNTIME_CLOSURE_LEGACY_EVIDENCE", "backend-health-recovery-evidence", "workflow_dispatch", "taskDefinitionFingerprint", "NOT_PART_OF_SCHEMA"]);
