...
const CALLS = Object.freeze([
  ...
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "secretsmanager:DescribeSecret", "bootstrap-operator-policy-reconciliation-read-initial-overlap-secrets", MIXED_DUAL_SLOT_RECOVERY_IAM_RESOURCES, "ROOT_OPERATOR", "verifyLiveInitialDualSlotBindingWithRunner"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "secretsmanager:GetSecretValue", "bootstrap-operator-policy-reconciliation-read-initial-overlap-values", MIXED_DUAL_SLOT_RECOVERY_IAM_RESOURCES, "ROOT_OPERATOR", "verifyLiveInitialDualSlotBindingWithRunner"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "secretsmanager:DescribeSecret", "bootstrap-operator-policy-authorization-read-initial-overlap-secrets", MIXED_DUAL_SLOT_RECOVERY_IAM_RESOURCES, "BOOTSTRAP_OPERATOR_POLICY_AUTHORIZER", "verifyLiveInitialDualSlotBindingWithRunner"],
  ["scripts/aws/production-bootstrap-operator-policy-reconciliation.mjs", "secretsmanager:GetSecretValue", "bootstrap-operator-policy-authorization-read-initial-overlap-values", MIXED_DUAL_SLOT_RECOVERY_IAM_RESOURCES, "BOOTSTRAP_OPERATOR_POLICY_AUTHORIZER", "verifyLiveInitialDualSlotBindingWithRunner"],
