...
const MODE_CAPABILITIES = Object.freeze({
  ...
  [MIXED_DUAL_SLOT_RECOVERY_MODE]: ["mixed-recovery-iam-preflight-identify", "mixed-recovery-iam-preflight-read-role", "mixed-recovery-iam-preflight-simulate", "mixed-recovery-iam-preflight-read-resource-policy", "mixed-recovery-iam-attestation-sign", "mixed-recovery-executor-identify", "mixed-recovery-executor-describe-service", "mixed-recovery-executor-describe-task-definition", "mixed-recovery-executor-describe-secret", "mixed-recovery-executor-get-secret-value", "mixed-recovery-remove-awscurrent"],
