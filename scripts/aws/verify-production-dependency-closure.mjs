...
export function buildProductionDependencyClosure() {
  ...
  requireTokens("scripts/aws/dispatch-production-backend-health-recovery.mjs", ["ROLLBACK_APPROVAL_FIELDS", "BACKEND_HEALTH_RECOVERY_DISPATCH_BUNDLE", "backend_recovery_evidence_bundle_gzip_base64", "backend_recovery_evidence_bundle_sha256", "MAX_DECOMPRESSED_BUNDLE_BYTES", "maxOutputLength"]);
