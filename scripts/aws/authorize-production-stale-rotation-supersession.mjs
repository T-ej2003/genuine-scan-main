...
import { createApprovedStaleRotationSupersessionAuthorization, createPendingStaleRotationSupersessionAuthorization, resolveStaleRotationSupersessionPublication } from "./production-stale-rotation-supersession-contract.mjs";
...
export async function runCli(argv = process.argv.slice(2), deps = {}) {
  ...
  await (deps.resolvePublication || resolveStaleRotationSupersessionPublication)({ publication: preparation.publication, sourceSha: preparation.sourceSha, run: deps.githubRun });
