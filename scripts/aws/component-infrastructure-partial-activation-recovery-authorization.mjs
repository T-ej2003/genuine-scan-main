...
async function prepare() {
  ...
  const preparation = { schemaVersion: 1, sourceSha, recoveryTransitionId: environmentValue("RECOVERY_TRANSITION_ID", uuid), stateIdentity: "INFRASTRUCTURE_CREATED_STATE_INCOMPLETE",
    ...
    historicalActivation: { activationAuthorizationSourceSha: environmentValue("HISTORICAL_ACTIVATION_AUTHORIZATION_SOURCE_SHA", /^[a-f0-9]{40}$/), installationReservationSourceSha: environmentValue("HISTORICAL_INSTALLATION_RESERVATION_SOURCE_SHA", /^[a-f0-9]{40}$/), authorizationRunId: environmentValue("HISTORICAL_AUTHORIZATION_RUN_ID", /^[1-9][0-9]*$/), authorizationArtifactSha256: environmentValue("HISTORICAL_AUTHORIZATION_ARTIFACT_SHA256", artifactSha), planSha256: environmentValue("HISTORICAL_PLAN_SHA256", sha), preparationSha256: environmentValue("HISTORICAL_PREPARATION_SHA256", sha), transitionId: environmentValue("HISTORICAL_TRANSITION_ID", uuid) },
