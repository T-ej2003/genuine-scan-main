...
const FIELDS = Object.freeze({
  ...
  unexpectedRoles: ["login","valid_until","superuser","inherit","create_role","create_database","replication","bypass_rls","security_state_sha256"],
  databases: ["owner"],
  ...
  operatorCapabilities: ["login","valid_until","superuser","inherit","create_role","create_database","replication","bypass_rls","database_connect","database_create","database_temporary"],
...
export function createLiveSecurityRebaselineInventory({ protectedMainSha, catalogue, canonical: canonicalInput, taskEvidence }) {
  ...
  const objects = normalizeSecurityRebaselineCatalogue(catalogue, { kind: "LIVE" }), body = { schemaVersion: 1, kind: "PRODUCTION_SECURITY_REBASELINE_LIVE_INVENTORY", protectedMainSha, postgresqlMajor: canonical.postgresqlMajor,
