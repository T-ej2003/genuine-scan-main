...
export function executeStageBStateReconciliation({ sourceSha, preparation, authorization, bindings, planBytes, planJson, readState, applyRefreshOnlyPlan, renderRefreshClosurePlan, renderNormalClosurePlan, reauthenticateSource, now = new Date() } = {}) {
  ...
  if (!bindings || bindings.tfvarsSha256 !== prepared.runtimeTfvarsSha256 || bindings.bindingSha256 !== prepared.runtimeBindingSha256 || bindings.preflightSha256 !== prepared.preflightSha256 || bindings.runtimeMaterializationSha256 !== prepared.runtimeMaterializationSha256 || bindings.prerequisiteManifestSha256 !== prepared.prerequisiteManifestSha256 || bindings.brokerPackageSha256 !== prepared.brokerPackageSha256 || bindings.brokerManifestSha256 !== prepared.brokerManifestSha256 || bindings.stageAInputSha256 !== prepared.stageAInputSha256 || bindings.stageAStateBackupSha256 !== prepared.stageAStateBackupSha256) throw new Error("Stage B state reconciliation execution inputs differ from the approved preparation.");
  ...
  const result = (status, successorState) => Object.freeze({ schemaVersion: 1, kind: "PRODUCTION_GREEN_STAGE_B_STATE_RECONCILIATION_RESULT", status, sourceSha, authorizationSha256: authorization.authorizationSha256, predecessorState: before, successorState, remainingExpectedStateObservations: 0, sourceToLiveIamSemanticDifferences: 0, newUnexpectedDriftCount: 0, remoteResourceMutationCount: 0, terraformStateMutationCount: 1 });
  const successor = () => {
