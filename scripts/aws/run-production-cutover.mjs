...
const adapters = createProductionCutoverAdapters({ config, sourceSha, rotationId, runtimeConfigSha256, releaseProfile: config.releaseProfile, verifierProfile: config.verifierProfile });
