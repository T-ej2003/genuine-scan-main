...
const adapters = createProductionCutoverAdapters({ config, sourceSha, rotationId, releaseProfile: config.releaseProfile, verifierProfile: config.verifierProfile });
