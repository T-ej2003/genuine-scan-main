...
export function runAuthorization(argv = process.argv.slice(2)) {
  ...
  const approval = readBoundStageBPrivateJson({ filePath: path.resolve(required(argv, "--environment-approval")), expectedSha256: required(argv, "--environment-approval-file-sha256"), repositoryRoot: root, label: "Stage B state reconciliation environment approval" });
