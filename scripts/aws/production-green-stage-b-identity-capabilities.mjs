...
export function readIdentityCapabilityMatrix() {
  ...
  if (matrix.schemaVersion !== 1 || matrix.account !== STAGE_B.account || matrix.region !== STAGE_B.region || matrix.phases?.length !== 35) throw new Error("Stage B identity capability matrix identity is wrong.");
