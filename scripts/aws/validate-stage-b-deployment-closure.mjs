...
if (mode === "production" || tfvarsPath || bindingReportPath) {
  ...
  if (mode === "production" && (recoveryPlan || partialApplyRecovery) && (!process.env.STAGE_B_REFRESH_BINDING_REPORT_PATH || !process.env.STAGE_B_REFRESH_BINDING_REPORT_SHA256)) throw new Error("Recovery closure requires the original observation binding report and SHA256.");
  ...
  if (mode === "production" && (recoveryPlan || partialApplyRecovery)) {
