...
export const STAGE_B_ARTIFACT_CONTRACTS = Object.freeze([
  ...
  { id: "app-only-requirements", kind: "file", producer: "scripts/aws/produce-production-app-only-requirements.mjs", consumers: ["scripts/aws/production-app-only-preparation.mjs", "scripts/aws/production-app-only-verifier-command.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
