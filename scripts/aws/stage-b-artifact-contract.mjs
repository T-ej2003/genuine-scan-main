...
export const STAGE_B_ARTIFACT_CONTRACTS = Object.freeze([
  ...
  { id: "stage-a-production-artifacts-continuation-rebind-authorization", kind: "file", producer: ".github/workflows/authorize-production-stage-a-production-artifacts-continuation-rebind.yml", consumers: ["scripts/aws/production-stage-a-production-artifacts-recovery-governance.mjs", "scripts/aws/run-production-stage-a-production-artifacts-reconciliation.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
