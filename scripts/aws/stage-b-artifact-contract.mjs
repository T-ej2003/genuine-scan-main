...
export const STAGE_B_ARTIFACT_CONTRACTS = Object.freeze([
  ...
  { id: "stage-b-approval-input", kind: "file", producer: "scripts/aws/prepare-production-green-stage-b-approval-input.mjs:run", consumers: ["scripts/aws/create-production-green-stage-b-approval.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
