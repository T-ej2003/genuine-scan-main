...
export const STAGE_B_ARTIFACT_CONTRACTS = Object.freeze([
  { id: "app-only-bootstrap-plan", kind: "file", producer: "scripts/aws/run-production-app-only-bootstrap.mjs:prepare", consumers: ["scripts/aws/run-production-app-only-bootstrap.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "app-only-bootstrap-authorization", kind: "file", producer: "scripts/aws/authorize-production-app-only-bootstrap.mjs", consumers: ["scripts/aws/run-production-app-only-bootstrap.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "app-only-deployment-inputs", kind: "file", producer: "scripts/aws/prepare-production-app-only-deployment.mjs", consumers: ["scripts/aws/run-production-app-only-deployment.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "app-only-release-preparation", kind: "file", producer: "scripts/aws/run-production-app-only-deployment.mjs:prepare", consumers: ["scripts/aws/run-production-app-only-deployment.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "app-only-permissions", kind: "file", producer: "scripts/aws/run-production-app-only-deployment.mjs:provision", consumers: ["scripts/aws/run-production-app-only-deployment.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "app-only-deployment-result", kind: "file", producer: "scripts/aws/run-production-app-only-deployment.mjs:deploy", consumers: ["documents/ops/production-app-only-deployment.md"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "app-only-requirements", kind: "file", producer: "scripts/aws/produce-production-app-only-requirements.mjs", consumers: ["scripts/aws/apply-production-printing-routine-delta.mjs", "scripts/aws/production-printing-routine-delta-executor.cjs", "scripts/aws/probe-production-rls-catalogue.mjs", "scripts/aws/production-app-only-preparation.mjs", "scripts/aws/production-app-only-verifier-command.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "app-only-verifier-preparation", kind: "file", producer: "scripts/aws/prepare-production-app-only-verifier.mjs", consumers: ["scripts/aws/production-app-only-adapters.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "app-only-verifier-registration", kind: "file", producer: "scripts/aws/run-production-app-only-verifier.mjs:register", consumers: ["scripts/aws/run-production-app-only-verifier.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "app-only-database-compatibility", kind: "file", producer: "scripts/aws/run-production-app-only-verifier.mjs:verify", consumers: ["scripts/aws/production-app-only-preparation.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "app-only-execution-journal", kind: "file", producer: "scripts/aws/production-app-only-artifacts.mjs:createAppOnlyEvidenceWriter", consumers: ["scripts/aws/production-app-only-activation.mjs", "scripts/aws/production-app-only-provisioning.mjs", "scripts/aws/production-app-only-adapters.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  ...
  { id: "release-preflight-report", kind: "file", producer: "scripts/aws/run-production-green-stage-b-preflight.mjs:runReleaseReadiness", consumers: ["scripts/aws/production-release-preflight-checker-attestation.mjs", "scripts/aws/prepare-production-cutover-runtime.mjs", "scripts/aws/production-cutover-runtime-bootstrap.mjs", "scripts/aws/production-cutover-production-adapters.mjs", "scripts/aws/forward-recover-stage-b-existing-revision.mjs", "scripts/aws/prepare-production-green-stage-b-approval-input.mjs", "scripts/aws/collect-production-green-stage-b-approval-evidence.mjs", "scripts/aws/reconcile-production-green-stage-b-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "release-preflight-checker-trust-attestation", kind: "file", producer: "scripts/aws/production-release-preflight-checker-attestation.mjs:runReleasePreflightCheckerTrustAttestationCli", consumers: ["scripts/aws/prepare-production-cutover-runtime.mjs", "scripts/aws/production-cutover-runtime-bootstrap.mjs", "scripts/aws/production-cutover-production-adapters.mjs", "scripts/aws/prepare-production-green-stage-b-approval-input.mjs", "scripts/aws/collect-production-green-stage-b-approval-evidence.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, atomicGroup: "release-preflight-checker-trust-attestation-pair", overwrite: false, hashBound: true },
  { id: "release-preflight-checker-trust-attestation-signature", kind: "file", producer: "scripts/aws/production-release-preflight-checker-attestation.mjs:runReleasePreflightCheckerTrustAttestationCli", consumers: ["scripts/aws/prepare-production-cutover-runtime.mjs", "scripts/aws/production-cutover-runtime-bootstrap.mjs", "scripts/aws/production-cutover-production-adapters.mjs", "scripts/aws/prepare-production-green-stage-b-approval-input.mjs", "scripts/aws/collect-production-green-stage-b-approval-evidence.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, atomicGroup: "release-preflight-checker-trust-attestation-pair", overwrite: false, hashBound: true },
  ...
  { id: "stale-rotation-supersession-replacement-reservation", kind: "file", producer: "scripts/aws/supersede-production-stale-rotation.mjs:runCli --mode prepare", consumers: ["scripts/aws/supersede-production-stale-rotation.mjs", "scripts/aws/production-stale-rotation-supersession-contract.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "stale-rotation-supersession-material-journal", kind: "file", producer: "scripts/aws/production-initial-dual-slot-bootstrap.mjs:supersedeStalePendingRotation --mode prepare", consumers: ["scripts/aws/supersede-production-stale-rotation.mjs", "scripts/aws/production-initial-dual-slot-bootstrap.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, secretMaterial: true },
  { id: "stale-rotation-supersession-preparation", kind: "file", producer: "scripts/aws/supersede-production-stale-rotation.mjs:runCli --mode prepare", consumers: [".github/workflows/authorize-production-stale-rotation-supersession.yml", "scripts/aws/authorize-production-stale-rotation-supersession.mjs", "scripts/aws/supersede-production-stale-rotation.mjs", "scripts/aws/production-stale-rotation-supersession-contract.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "stale-rotation-supersession-authorization", kind: "file", producer: ".github/workflows/authorize-production-stale-rotation-supersession.yml", consumers: ["scripts/aws/supersede-production-stale-rotation.mjs", "scripts/aws/production-stale-rotation-supersession-contract.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  { id: "stale-rotation-supersession-execution-start", kind: "file", producer: "scripts/aws/supersede-production-stale-rotation.mjs:runCli --mode execute", consumers: ["scripts/aws/supersede-production-stale-rotation.mjs", "scripts/aws/production-stale-rotation-supersession-contract.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "stale-rotation-supersession-consumption", kind: "file", producer: "scripts/aws/supersede-production-stale-rotation.mjs:runCli --mode execute", consumers: ["scripts/aws/supersede-production-stale-rotation.mjs", "scripts/aws/production-stale-rotation-supersession-contract.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "stale-rotation-supersession-evidence", kind: "file", producer: "scripts/aws/production-initial-dual-slot-bootstrap.mjs:supersedeStalePendingRotation --mode execute", consumers: ["scripts/aws/production-initial-dual-slot-bootstrap.mjs", "scripts/security/production-initial-migration-source-advance.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  ...
  { id: "mixed-dual-slot-recovery-preparation", kind: "file", producer: "scripts/aws/run-production-mixed-dual-slot-topology-recovery.mjs:--prepare", consumers: [".github/workflows/authorize-production-mixed-dual-slot-topology-recovery.yml", ".github/workflows/execute-production-mixed-dual-slot-topology-recovery.yml", "scripts/aws/authorize-production-mixed-dual-slot-topology-recovery.mjs", "scripts/aws/run-production-mixed-dual-slot-topology-recovery.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "mixed-dual-slot-recovery-iam-attestation", kind: "file", producer: "scripts/aws/run-production-mixed-dual-slot-topology-recovery.mjs:--prepare", consumers: [".github/workflows/authorize-production-mixed-dual-slot-topology-recovery.yml", "scripts/aws/authorize-production-mixed-dual-slot-topology-recovery.mjs", "scripts/aws/verify-production-mixed-dual-slot-recovery-iam-attestation.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "mixed-dual-slot-recovery-authorization", kind: "file", producer: ".github/workflows/authorize-production-mixed-dual-slot-topology-recovery.yml", consumers: ["scripts/aws/production-mixed-dual-slot-recovery-contract.mjs", "scripts/aws/run-production-mixed-dual-slot-topology-recovery.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  { id: "dual-slot-rebaseline-durable-evidence-submission", kind: "file", producer: "scripts/aws/produce-production-dual-slot-rebaseline-durable-evidence.mjs", consumers: ["scripts/aws/persist-production-dual-slot-rebaseline-durable-evidence.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "dual-slot-rebaseline-durable-evidence", kind: "file", producer: "scripts/aws/persist-production-dual-slot-rebaseline-durable-evidence.mjs", consumers: ["scripts/aws/production-dual-slot-rebaseline-contract.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  ...
  { id: "stage-b-prerequisite-bundle", kind: "file", producer: "scripts/aws/produce-production-green-stage-b-prerequisite-bundle.mjs:produceStageBPrerequisiteBundle", consumers: ["scripts/aws/reconcile-production-green-stage-b-state.mjs", ".github/workflows/prepare-production-green-stage-b-state-reconciliation.yml", ".github/workflows/execute-production-green-stage-b-state-reconciliation.yml"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  { id: "stage-b-runtime-materialization", kind: "file", producer: "scripts/aws/stage-b-prerequisite-bundle.mjs:writeStageBRuntimeMaterialization", consumers: ["scripts/aws/reconcile-production-green-stage-b-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "tfvars", kind: "file", producer: "scripts/aws/generate-production-green-stage-b-tfvars.mjs:writeAtomicPair", consumers: ["scripts/refresh-production-green-stage-b.mjs", "scripts/plan-production-green-stage-b.mjs", "scripts/aws/validate-stage-b-deployment-closure.mjs", "scripts/apply-production-green-stage-b.mjs", "scripts/aws/collect-production-green-stage-b-approval-evidence.mjs", "scripts/aws/production-cutover-production-adapters.mjs", "scripts/aws/production-cutover-runtime-bootstrap.mjs", "scripts/aws/prepare-production-cutover-runtime.mjs", "scripts/aws/forward-recover-stage-b-existing-revision.mjs", "scripts/aws/recover-stage-b-backend-task-definition.mjs", "scripts/aws/reconcile-production-green-stage-b-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "tfvars-binding-report", kind: "file", producer: "scripts/aws/generate-production-green-stage-b-tfvars.mjs:writeAtomicPair", consumers: ["scripts/refresh-production-green-stage-b.mjs", "scripts/plan-production-green-stage-b.mjs", "scripts/aws/validate-stage-b-deployment-closure.mjs", "scripts/apply-production-green-stage-b.mjs", "scripts/aws/collect-production-green-stage-b-approval-evidence.mjs", "scripts/aws/production-cutover-production-adapters.mjs", "scripts/aws/production-cutover-runtime-bootstrap.mjs", "scripts/aws/prepare-production-cutover-runtime.mjs", "scripts/aws/forward-recover-stage-b-existing-revision.mjs", "scripts/aws/recover-stage-b-backend-task-definition.mjs", "scripts/aws/reconcile-production-green-stage-b-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  ...
  { id: "stage-b-approval-input", kind: "file", producer: "scripts/aws/prepare-production-green-stage-b-approval-input.mjs:run", consumers: ["scripts/aws/create-production-green-stage-b-approval.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, atomicGroup: "stage-b-approval-input-review-pair", overwrite: false, hashBound: true },
  { id: "stage-b-approval-review", kind: "file", producer: "scripts/aws/prepare-production-green-stage-b-approval-input.mjs:run", consumers: ["documents/security/rls-program/FULL_DATABASE_PRODUCTION_ACTIVATION_RUNBOOK.md"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, atomicGroup: "stage-b-approval-input-review-pair", overwrite: false, hashBound: true },
  ...
  { id: "stage-a-production-artifacts-continuation-rebind-authorization", kind: "file", producer: ".github/workflows/authorize-production-stage-a-production-artifacts-continuation-rebind.yml", consumers: ["scripts/aws/authorize-production-stage-a-production-artifacts-reconciliation.mjs", "scripts/aws/production-stage-a-production-artifacts-recovery-governance.mjs", "scripts/aws/run-production-stage-a-production-artifacts-reconciliation.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  ...
  { id: "initial-activation-reconciler-bootstrap-preparation", kind: "file", producer: "scripts/aws/production-initial-activation-reconciler-bootstrap.mjs:runBootstrapCli --prepare", consumers: [".github/workflows/authorize-production-initial-activation-policy-reconciler-bootstrap.yml", "scripts/aws/production-initial-activation-reconciler-bootstrap.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-bootstrap-authorization", kind: "file", producer: ".github/workflows/authorize-production-initial-activation-policy-reconciler-bootstrap.yml", consumers: ["scripts/aws/production-initial-activation-reconciler-bootstrap.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  { id: "initial-activation-reconciler-bootstrap-result", kind: "file", producer: "scripts/aws/production-initial-activation-reconciler-bootstrap.mjs:runBootstrapCli --execute", consumers: ["documents/ops/iam/MSCQR_PRODUCTION_INITIAL_ACTIVATION_RECONCILER_BOOTSTRAP.md"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-installation-saved-plan", kind: "file", producer: "scripts/aws/prepare-production-initial-activation-reconciler-installation.mjs:terraformPlan", consumers: [".github/workflows/authorize-production-initial-activation-policy-reconciler-installation.yml", "scripts/aws/dispatch-production-initial-activation-reconciler-installation.mjs", "scripts/aws/prepare-production-initial-activation-reconciler-installation.mjs", "scripts/aws/install-production-initial-activation-reconciler.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-installation-plan-json", kind: "file", producer: "scripts/aws/prepare-production-initial-activation-reconciler-installation.mjs:terraformPlan", consumers: ["scripts/aws/prepare-production-initial-activation-reconciler-installation.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-installation-preparation", kind: "file", producer: "scripts/aws/prepare-production-initial-activation-reconciler-installation.mjs:prepareInstallation", consumers: [".github/workflows/authorize-production-initial-activation-policy-reconciler-installation.yml", "scripts/aws/authorize-production-initial-activation-reconciler-installation.mjs", "scripts/aws/dispatch-production-initial-activation-reconciler-installation.mjs", "scripts/aws/install-production-initial-activation-reconciler.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-installation-authorization", kind: "file", producer: ".github/workflows/authorize-production-initial-activation-policy-reconciler-installation.yml", consumers: ["scripts/aws/install-production-initial-activation-reconciler.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  { id: "initial-activation-reconciler-installation-result", kind: "file", producer: "scripts/aws/install-production-initial-activation-reconciler.mjs:executeInstallation", consumers: [".github/workflows/authorize-production-initial-activation-policy-reconciler-installation.yml", "scripts/aws/install-production-initial-activation-reconciler.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-state-reconciliation-saved-plan", kind: "file", producer: "scripts/aws/reconcile-production-initial-activation-reconciler-state.mjs:runReconcilerStateReconciliation --mode prepare", consumers: [".github/workflows/authorize-production-initial-activation-reconciler-state-reconciliation.yml", ".github/workflows/execute-production-initial-activation-reconciler-state-reconciliation.yml", "scripts/aws/reconcile-production-initial-activation-reconciler-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-state-reconciliation-preparation", kind: "file", producer: "scripts/aws/reconcile-production-initial-activation-reconciler-state.mjs:runReconcilerStateReconciliation --mode prepare", consumers: [".github/workflows/authorize-production-initial-activation-reconciler-state-reconciliation.yml", ".github/workflows/execute-production-initial-activation-reconciler-state-reconciliation.yml", "scripts/aws/authorize-production-initial-activation-reconciler-state-reconciliation.mjs", "scripts/aws/reconcile-production-initial-activation-reconciler-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-state-reconciliation-authorization", kind: "file", producer: ".github/workflows/authorize-production-initial-activation-reconciler-state-reconciliation.yml", consumers: [".github/workflows/execute-production-initial-activation-reconciler-state-reconciliation.yml", "scripts/aws/reconcile-production-initial-activation-reconciler-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  { id: "initial-activation-reconciler-state-reconciliation-result", kind: "file", producer: "scripts/aws/reconcile-production-initial-activation-reconciler-state.mjs:runReconcilerStateReconciliation --mode execute", consumers: [".github/workflows/execute-production-initial-activation-reconciler-state-reconciliation.yml", "documents/ops/iam/MSCQRProductionInitialActivationReconcilerStateReconciliation-v1.md"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-state-reconciliation-recovery-preparation", kind: "file", producer: "scripts/aws/reconcile-production-initial-activation-reconciler-state.mjs:runReconcilerStateReconciliation --mode recovery-prepare", consumers: [".github/workflows/authorize-production-initial-activation-reconciler-state-reconciliation-recovery.yml", ".github/workflows/execute-production-initial-activation-reconciler-state-reconciliation-recovery.yml", "scripts/aws/authorize-production-initial-activation-reconciler-state-reconciliation-recovery.mjs", "scripts/aws/reconcile-production-initial-activation-reconciler-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-state-reconciliation-recovery-authorization", kind: "file", producer: ".github/workflows/authorize-production-initial-activation-reconciler-state-reconciliation-recovery.yml", consumers: [".github/workflows/execute-production-initial-activation-reconciler-state-reconciliation-recovery.yml", "scripts/aws/reconcile-production-initial-activation-reconciler-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  { id: "initial-activation-reconciler-state-reconciliation-recovery-result", kind: "file", producer: "scripts/aws/reconcile-production-initial-activation-reconciler-state.mjs:runReconcilerStateReconciliation --mode recovery-execute", consumers: [".github/workflows/execute-production-initial-activation-reconciler-state-reconciliation-recovery.yml", "documents/ops/iam/MSCQRProductionInitialActivationReconcilerStateReconciliation-v1.md"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-exact-complete-state-reconciliation-saved-plan", kind: "file", producer: "scripts/aws/reconcile-production-initial-activation-exact-complete-state.mjs:runExactCompleteStateReconciliation --mode prepare", consumers: [".github/workflows/authorize-production-initial-activation-exact-complete-state-reconciliation.yml", ".github/workflows/execute-production-initial-activation-exact-complete-state-reconciliation.yml", "scripts/aws/reconcile-production-initial-activation-exact-complete-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-exact-complete-state-reconciliation-preparation", kind: "file", producer: "scripts/aws/reconcile-production-initial-activation-exact-complete-state.mjs:runExactCompleteStateReconciliation --mode prepare", consumers: [".github/workflows/authorize-production-initial-activation-exact-complete-state-reconciliation.yml", ".github/workflows/execute-production-initial-activation-exact-complete-state-reconciliation.yml", "scripts/aws/authorize-production-initial-activation-exact-complete-state-reconciliation.mjs", "scripts/aws/reconcile-production-initial-activation-exact-complete-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-exact-complete-state-reconciliation-authorization", kind: "file", producer: ".github/workflows/authorize-production-initial-activation-exact-complete-state-reconciliation.yml", consumers: [".github/workflows/execute-production-initial-activation-exact-complete-state-reconciliation.yml", "scripts/aws/reconcile-production-initial-activation-exact-complete-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  { id: "initial-activation-reconciler-exact-complete-state-reconciliation-result", kind: "file", producer: "scripts/aws/reconcile-production-initial-activation-exact-complete-state.mjs:runExactCompleteStateReconciliation --mode execute", consumers: [".github/workflows/execute-production-initial-activation-exact-complete-state-reconciliation.yml", "documents/ops/iam/MSCQRProductionInitialActivationExactCompleteStateReconciliation-v1.md"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-exact-complete-state-reconciliation-recovery-preparation", kind: "file", producer: "scripts/aws/reconcile-production-initial-activation-exact-complete-state.mjs:runExactCompleteStateReconciliation --mode recovery-prepare", consumers: [".github/workflows/authorize-production-initial-activation-exact-complete-state-reconciliation-recovery.yml", ".github/workflows/execute-production-initial-activation-exact-complete-state-reconciliation-recovery.yml", "scripts/aws/authorize-production-initial-activation-exact-complete-state-reconciliation-recovery.mjs", "scripts/aws/reconcile-production-initial-activation-exact-complete-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-exact-complete-state-reconciliation-recovery-authorization", kind: "file", producer: ".github/workflows/authorize-production-initial-activation-exact-complete-state-reconciliation-recovery.yml", consumers: [".github/workflows/execute-production-initial-activation-exact-complete-state-reconciliation-recovery.yml", "scripts/aws/reconcile-production-initial-activation-exact-complete-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  { id: "initial-activation-reconciler-exact-complete-state-reconciliation-recovery-result", kind: "file", producer: "scripts/aws/reconcile-production-initial-activation-exact-complete-state.mjs:runExactCompleteStateReconciliation --mode recovery-execute", consumers: [".github/workflows/execute-production-initial-activation-exact-complete-state-reconciliation-recovery.yml", "documents/ops/iam/MSCQRProductionInitialActivationExactCompleteStateReconciliation-v1.md"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "initial-activation-lifecycle-policy-reconciliation-authorization", kind: "file", producer: ".github/workflows/authorize-production-initial-activation-lifecycle-policy-reconciliation.yml", consumers: ["scripts/aws/run-production-initial-activation-lifecycle-policy-reconciliation.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  { id: "initial-activation-lifecycle-policy-reconciliation-result", kind: "file", producer: "scripts/aws/run-production-initial-activation-lifecycle-policy-reconciliation.mjs:runInitialActivationLifecyclePolicyReconciliation --execute", consumers: [".github/workflows/authorize-production-initial-activation-lifecycle-policy-reconciliation.yml"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "provider-readonly-policy-reconciliation-preparation", kind: "file", producer: "scripts/aws/reconcile-production-provider-readonly-policy.mjs:runProviderReadonlyReconciliation --mode prepare", consumers: [".github/workflows/authorize-production-provider-readonly-policy-reconciliation.yml", "scripts/aws/authorize-production-provider-readonly-policy-reconciliation.mjs", "scripts/aws/reconcile-production-provider-readonly-policy.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "provider-readonly-policy-reconciliation-authorization", kind: "file", producer: ".github/workflows/authorize-production-provider-readonly-policy-reconciliation.yml", consumers: [".github/workflows/execute-production-provider-readonly-policy-reconciliation.yml", "scripts/aws/reconcile-production-provider-readonly-policy.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  { id: "provider-readonly-policy-reconciliation-result", kind: "file", producer: "scripts/aws/reconcile-production-provider-readonly-policy.mjs:runProviderReadonlyReconciliation --mode execute", consumers: [".github/workflows/execute-production-provider-readonly-policy-reconciliation.yml", "documents/ops/iam/MSCQRProductionProviderReadOnly-reconciliation.md"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  ...
  { id: "backend-log-diagnostic-authorization", kind: "file", producer: ".github/workflows/authorize-production-backend-log-diagnostic.yml", consumers: ["scripts/aws/production-backend-log-diagnostic.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  { id: "backend-log-diagnostic-state", kind: "file", producer: "scripts/aws/production-backend-log-diagnostic.mjs", consumers: ["scripts/aws/production-backend-log-diagnostic.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: true, hashBound: true },
  { id: "backend-log-diagnostic-evidence", kind: "file", producer: "scripts/aws/production-backend-log-diagnostic.mjs", consumers: ["documents/ops/PRODUCTION_BACKEND_FAILED_RECOVERY_LOG_DIAGNOSTIC.md"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  ...
  { id: "apply-attempt-transition", kind: "file", producer: "scripts/apply-production-green-stage-b.mjs:reserveStageBApplyAttemptTransition", consumers: ["scripts/aws/stage-b-apply-attempt-reconciliation.mjs", "documents/security/rls-program/PRODUCTION_GREEN_STAGE_B_MUTATION_CLOSURE_2026-08-16.md"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "apply-attempt-reconciliation", kind: "file", producer: "scripts/aws/stage-b-apply-attempt-reconciliation.mjs:create-reconciliation", consumers: ["scripts/aws/stage-b-apply-attempt-reconciliation.mjs", ".github/workflows/authorize-production-green-stage-b-apply-attempt-reconciliation.yml"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "apply-attempt-reconciliation-authorization", kind: "file", producer: ".github/workflows/authorize-production-green-stage-b-apply-attempt-reconciliation.yml", consumers: ["scripts/aws/stage-b-apply-attempt-reconciliation.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  ...
  { id: "stage-b-ten-address-state-reconciliation-saved-plan", kind: "file", producer: "scripts/aws/reconcile-production-green-stage-b-state.mjs:runStageBStateReconciliation --mode prepare", consumers: [".github/workflows/prepare-production-green-stage-b-state-reconciliation.yml", ".github/workflows/execute-production-green-stage-b-state-reconciliation.yml", "scripts/aws/reconcile-production-green-stage-b-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "stage-b-ten-address-state-reconciliation-preparation", kind: "file", producer: "scripts/aws/reconcile-production-green-stage-b-state.mjs:runStageBStateReconciliation --mode prepare", consumers: [".github/workflows/prepare-production-green-stage-b-state-reconciliation.yml", ".github/workflows/authorize-production-green-stage-b-state-reconciliation.yml", ".github/workflows/execute-production-green-stage-b-state-reconciliation.yml", "scripts/aws/authorize-production-green-stage-b-state-reconciliation.mjs", "scripts/aws/reconcile-production-green-stage-b-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "stage-b-ten-address-state-reconciliation-authorization", kind: "file", producer: ".github/workflows/authorize-production-green-stage-b-state-reconciliation.yml", consumers: [".github/workflows/execute-production-green-stage-b-state-reconciliation.yml", "scripts/aws/reconcile-production-green-stage-b-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
  { id: "stage-b-ten-address-state-reconciliation-result", kind: "file", producer: "scripts/aws/reconcile-production-green-stage-b-state.mjs:runStageBStateReconciliation --mode execute", consumers: [".github/workflows/execute-production-green-stage-b-state-reconciliation.yml", "documents/ops/iam/PRODUCTION_GREEN_STAGE_B_REFRESH_ONLY_STATE_RECONCILIATION.md"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
]);
...
const STAGE_A_RECONCILIATION_ARTIFACT_IDS = Object.freeze([
  ...
  "stage-a-production-artifacts-continuation-rebind-authorization",
