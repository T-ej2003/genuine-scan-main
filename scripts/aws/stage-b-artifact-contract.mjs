...
export const STAGE_B_ARTIFACT_CONTRACTS = Object.freeze([
  ...
  { id: "stage-b-ten-address-state-reconciliation-saved-plan", kind: "file", producer: "scripts/aws/reconcile-production-green-stage-b-state.mjs:runStageBStateReconciliation --mode prepare", consumers: [".github/workflows/execute-production-green-stage-b-state-reconciliation.yml", "scripts/aws/reconcile-production-green-stage-b-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "stage-b-ten-address-state-reconciliation-preparation", kind: "file", producer: "scripts/aws/reconcile-production-green-stage-b-state.mjs:runStageBStateReconciliation --mode prepare", consumers: [".github/workflows/authorize-production-green-stage-b-state-reconciliation.yml", ".github/workflows/execute-production-green-stage-b-state-reconciliation.yml", "scripts/aws/authorize-production-green-stage-b-state-reconciliation.mjs", "scripts/aws/reconcile-production-green-stage-b-state.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
