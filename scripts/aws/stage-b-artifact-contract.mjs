...
export const STAGE_B_ARTIFACT_CONTRACTS = Object.freeze([
  ...
  { id: "initial-activation-reconciler-installation-saved-plan", kind: "file", producer: "scripts/aws/prepare-production-initial-activation-reconciler-installation.mjs:terraformPlan", consumers: ["scripts/aws/prepare-production-initial-activation-reconciler-installation.mjs", "scripts/aws/install-production-initial-activation-reconciler.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: false, overwrite: false, hashBound: true },
  { id: "initial-activation-reconciler-installation-plan-json", kind: "file", producer: "scripts/aws/prepare-production-initial-activation-reconciler-installation.mjs:terraformPlan", consumers: ["scripts/aws/prepare-production-initial-activation-reconciler-installation.mjs", "scripts/aws/install-production-initial-activation-reconciler.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
