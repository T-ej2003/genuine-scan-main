...
export const STAGE_B_ARTIFACT_CONTRACTS = Object.freeze([
  ...
  { id: "initial-dual-slot-rotation-supersession-manifest", kind: "file", producer: "scripts/aws/supersede-production-stale-rotation.mjs", consumers: ["scripts/aws/prepare-production-cutover-runtime.mjs", "scripts/aws/production-cutover-runtime-bootstrap.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
