...
export const STAGE_B_ARTIFACT_CONTRACTS = Object.freeze([
  ...
  { id: "release-preflight-report", kind: "file", producer: "scripts/aws/run-production-green-stage-b-preflight.mjs:runReleaseReadiness", consumers: ["scripts/aws/production-cutover-runtime-bootstrap.mjs", "scripts/aws/production-cutover-production-adapters.mjs", "scripts/aws/production-cutover-control-plane.mjs", "scripts/aws/validate-stage-b-deployment-closure.mjs", "scripts/plan-production-green-stage-b.mjs", "scripts/apply-production-green-stage-b.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "release-preflight-checker-trust-attestation", kind: "file", producer: "scripts/aws/production-release-preflight-checker-attestation.mjs:runReleasePreflightCheckerTrustAttestationCli", consumers: ["scripts/aws/production-cutover-runtime-bootstrap.mjs", "scripts/aws/production-cutover-production-adapters.mjs", "scripts/aws/production-cutover-control-plane.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "release-preflight-checker-trust-attestation-signature", kind: "file", producer: "scripts/aws/production-release-preflight-checker-attestation.mjs:runReleasePreflightCheckerTrustAttestationCli", consumers: ["scripts/aws/production-cutover-runtime-bootstrap.mjs", "scripts/aws/production-cutover-production-adapters.mjs", "scripts/aws/production-cutover-control-plane.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
