...
export const STAGE_B_ARTIFACT_CONTRACTS = Object.freeze([
  ...
  { id: "dual-slot-rebaseline-completion", kind: "file", producer: "scripts/aws/production-dual-slot-rebaseline-contract.mjs:executeProductionDualSlotRebaseline", consumers: ["scripts/aws/production-cutover-runtime-bootstrap.mjs", "scripts/aws/prepare-production-cutover-runtime.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
