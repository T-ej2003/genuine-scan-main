...
export const STAGE_B_ARTIFACT_CONTRACTS = Object.freeze([
  ...
  { id: "stage-a-readiness-report", kind: "file", producer: "scripts/aws/run-production-green-stage-b-preflight.mjs:runStageAReadinessEvidence", consumers: ["scripts/aws/reconcile-production-stage-a-temporary-kms-capability.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "stage-a-readiness-signature", kind: "file", producer: "scripts/aws/run-production-green-stage-b-preflight.mjs:runStageAReadinessEvidence", consumers: ["scripts/aws/reconcile-production-stage-a-temporary-kms-capability.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
