...
export const STAGE_B_ARTIFACT_CONTRACTS = Object.freeze([
  ...
  { id: "dual-slot-rebaseline-durable-evidence-submission", kind: "file", producer: "scripts/aws/produce-production-dual-slot-rebaseline-durable-evidence.mjs", consumers: ["scripts/aws/publish-production-dual-slot-rebaseline-durable-evidence.mjs", ".github/workflows/persist-production-dual-slot-rebaseline-evidence.yml"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true },
  { id: "dual-slot-rebaseline-durable-evidence", kind: "file", producer: ".github/workflows/persist-production-dual-slot-rebaseline-evidence.yml", consumers: ["scripts/aws/production-dual-slot-rebaseline-contract.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
