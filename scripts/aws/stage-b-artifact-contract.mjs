...
export const STAGE_B_ARTIFACT_CONTRACTS = Object.freeze([
  ...
  { id: "stage-a-approval-key-reconciliation-authorization", kind: "file", producer: ".github/workflows/authorize-production-stage-a-reconciliation.yml", consumers: ["scripts/aws/production-stage-a-approval-key-reconciliation-authorization.mjs"], directoryMode: "0700", fileMode: "0600", symlink: "reject", outsideRepository: true, atomic: true, overwrite: false, hashBound: true, externalProducer: true },
