...
export const PRODUCTION_ENVIRONMENT_APPROVAL = Object.freeze({
  ...
  stageAProductionArtifactsContinuationRebindWorkflowRef: "T-ej2003/genuine-scan-main/.github/workflows/authorize-production-stage-a-production-artifacts-continuation-rebind.yml@refs/heads/main",
  stageATemporaryEgressCleanupWorkflowRef: "T-ej2003/genuine-scan-main/.github/workflows/authorize-stage-a-temporary-egress-cleanup.yml@refs/heads/main",
  initialActivationLifecyclePolicyReconciliationWorkflowRef: "T-ej2003/genuine-scan-main/.github/workflows/authorize-production-initial-activation-lifecycle-policy-reconciliation.yml@refs/heads/main",
  ...
  mixedDualSlotRecoveryAuthorizationWorkflowRef: "T-ej2003/genuine-scan-main/.github/workflows/authorize-production-mixed-dual-slot-topology-recovery.yml@refs/heads/main",
  ...
  stageBStateReconciliationWorkflowRef: "T-ej2003/genuine-scan-main/.github/workflows/authorize-production-green-stage-b-state-reconciliation.yml@refs/heads/main",
  appOnlyBootstrapWorkflowRef: "T-ej2003/genuine-scan-main/.github/workflows/authorize-production-app-only-bootstrap.yml@refs/heads/main",
  appOnlyVerifierWorkflowRef: "T-ej2003/genuine-scan-main/.github/workflows/verify-production-app-only-compatibility.yml@refs/heads/main",
...
const approvedWorkflowRefs = new Set([
  ...
  PRODUCTION_ENVIRONMENT_APPROVAL.stageAProductionArtifactsContinuationRebindWorkflowRef,
  PRODUCTION_ENVIRONMENT_APPROVAL.stageATemporaryEgressCleanupWorkflowRef,
  PRODUCTION_ENVIRONMENT_APPROVAL.initialActivationLifecyclePolicyReconciliationWorkflowRef,
  ...
  PRODUCTION_ENVIRONMENT_APPROVAL.mixedDualSlotRecoveryAuthorizationWorkflowRef,
  PRODUCTION_ENVIRONMENT_APPROVAL.stageBApplyAttemptReconciliationWorkflowRef,
  PRODUCTION_ENVIRONMENT_APPROVAL.stageBStateReconciliationWorkflowRef,
  PRODUCTION_ENVIRONMENT_APPROVAL.appOnlyBootstrapWorkflowRef,
  PRODUCTION_ENVIRONMENT_APPROVAL.appOnlyVerifierWorkflowRef,
