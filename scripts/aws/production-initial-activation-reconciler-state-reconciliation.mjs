...
const normalPlanFields = ["plannedResourceCount", "resourceChangeCount", "actionableResourceChangeCount", "createCount", "noOpCount", "updateCount", "deleteCount", "replaceCount", "resourceDriftCount", "resourceDriftSha256", "changedAddresses", "noOpAddresses", "resourceChanges"];
