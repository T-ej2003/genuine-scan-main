...
const manualSuccessTranscript = fs.readFileSync(new URL("./staging-ecs-runtime-identity-manual-success.txt", import.meta.url), "utf8");
...
export const runtimeIdentityParserFixtures = Object.freeze([
  ...
  { name: "ansi-control-session-banner", result: { status: 0, stdout: `\u001b]0;Session Manager\u0007\u001b[33mStarting session.\u001b[0m\n${block()}`, stderr: "" }, expected: "ok" },
  ...
  { name: "manual-success-transcript", result: { status: 0, stdout: manualSuccessTranscript, stderr: "" }, expected: "ok", expectedIdentity: { expectedUser: C.runtimeAdminRole }, expectedResult: { databaseName: C.databaseName, databaseUser: C.runtimeAdminRole } },
  { name: "kms-handshake-failed", result: { status: 1, stdout: "", stderr: "Session handshake failed while validating the KMS encryption key." }, expected: "session_handshake_failed" },
