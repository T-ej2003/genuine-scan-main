...
import { MIXED_DUAL_SLOT_PREDECESSOR, MIXED_DUAL_SLOT_RECOVERY_ARTIFACT, MIXED_DUAL_SLOT_RECOVERY_EXECUTION_ROLE_ARN, MIXED_DUAL_SLOT_RECOVERY_IAM_ACTION, MIXED_DUAL_SLOT_RECOVERY_IAM_CAPABILITIES, MIXED_DUAL_SLOT_RECOVERY_IAM_RESOURCES, MIXED_DUAL_SLOT_RECOVERY_OIDC_PROVIDER_ARN, assertMixedDualSlotRecoveryAuthorization, buildMixedDualSlotRecoveryIamPreflight, buildMixedDualSlotRecoveryPreparation, createMixedDualSlotRecoveryAuthorization, resolveMixedDualSlotRecoveryAuthorizationArtifact } from "../aws/production-mixed-dual-slot-recovery-contract.mjs";
...
const githubEnvironmentGuard = { environmentId: 9, environmentName: "production-mixed-dual-slot-recovery", deploymentBranchPolicy: { protectedBranches: false, customBranchPolicies: true }, branchPolicyId: 10, branchPolicyName: "main", branchPolicyType: "branch", protectionRules: [] };
const iamCapabilityPreflight = buildMixedDualSlotRecoveryIamPreflight({ sourceSha, principalArn: MIXED_DUAL_SLOT_RECOVERY_EXECUTION_ROLE_ARN, action: MIXED_DUAL_SLOT_RECOVERY_IAM_ACTION, resources: [...MIXED_DUAL_SLOT_RECOVERY_IAM_RESOURCES], roleTrustPolicySha256: "1".repeat(64), oidcProviderGuard: { providerArn: MIXED_DUAL_SLOT_RECOVERY_OIDC_PROVIDER_ARN, url: "token.actions.githubusercontent.com", audience: "sts.amazonaws.com" }, githubEnvironmentGuard, organizationsGuard: { accountId: "368992683803", status: "NOT_IN_ORGANIZATION", evidence: "AWSOrganizationsNotInUseException" }, resourcePolicies: MIXED_DUAL_SLOT_RECOVERY_IAM_RESOURCES.map((resource) => ({ resource, resourcePolicySha256: "74234e98afe7498fb5daf1f36ac2d78acc339464f950703b8c019892f982b90b", resourcePolicyAccess: "NO_RESOURCE_POLICY" })), evaluations: MIXED_DUAL_SLOT_RECOVERY_IAM_CAPABILITIES.flatMap(({ action, resources }) => resources.map((resource) => ({ action, resource, decision: "allowed", missingContextValues: [], organizationsAllowed: true, permissionsBoundaryAllowed: null }))), observedAt });
