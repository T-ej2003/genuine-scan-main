...
test("GitHub authorization runner rejects write-shaped gh api invocations", () => {
  ...
  for (const endpoint of ["repos/T-ej2003/genuine-scan-main/environments/production", "repos/T-ej2003/genuine-scan-main/actions/runs/123/approvals", "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts"]) assert.doesNotThrow(() => run("gh", ["api", endpoint, "--paginate", "--slurp"]));
