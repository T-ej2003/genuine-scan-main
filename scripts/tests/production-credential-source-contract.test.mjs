...
test("GitHub authorization runner rejects write-shaped gh api invocations", () => {
  ...
  assert.doesNotThrow(() => run("gh", ["api", "repos/T-ej2003/genuine-scan-main/actions/workflows/produce-production-app-only-requirements.yml/runs?branch=main&event=workflow_dispatch&status=success&per_page=100"]));
  for (const endpoint of ["repos/T-ej2003/genuine-scan-main/environments/production", "repos/T-ej2003/genuine-scan-main/environments/production-initial-activation-reconciler-bootstrap", "repos/T-ej2003/genuine-scan-main/environments/production-mixed-dual-slot-recovery", "repos/T-ej2003/genuine-scan-main/environments/production-bootstrap-operator-policy-authorization", "repos/T-ej2003/genuine-scan-main/environments/production-mixed-dual-slot-recovery/deployment_protection_rules", "repos/T-ej2003/genuine-scan-main/environments/production-mixed-dual-slot-recovery/secrets", "repos/T-ej2003/genuine-scan-main/actions/runs/123", "repos/T-ej2003/genuine-scan-main/actions/artifacts/456/zip"]) assert.doesNotThrow(() => run("gh", ["api", endpoint]));
  for (const endpoint of ["repos/T-ej2003/genuine-scan-main/environments/production-mixed-dual-slot-recovery/deployment-branch-policies", "repos/T-ej2003/genuine-scan-main/actions/runs/123/approvals", "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts", "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts?per_page=100"]) assert.doesNotThrow(() => run("gh", ["api", endpoint, "--paginate", "--slurp"]));
  for (const endpoint of ["repos/T-ej2003/genuine-scan-main/environments/staging", "repos/T-ej2003/genuine-scan-main/environments/foo", "repos/T-ej2003/genuine-scan-main/environments/production-initial-activation-reconciler-bootstrap/anything", "repos/T-ej2003/genuine-scan-main/environments/production/deployment-branch-policies", "repos/T-ej2003/genuine-scan-main/environments/production/deployment_protection_rules", "repos/T-ej2003/genuine-scan-main/environments/production-mixed-dual-slot-recovery/other", "repos/T-ej2003/genuine-scan-main/actions/workflows/other.yml/runs?branch=main&event=workflow_dispatch&status=success&per_page=100", "repos/T-ej2003/genuine-scan-main/actions/workflows/produce-production-app-only-requirements.yml/runs?branch=other&event=workflow_dispatch&status=success&per_page=100", "repos/other/repository/environments/production"]) assert.throws(() => run("gh", ["api", endpoint]), /reviewed read-only/);
  ...
  for (const endpoint of ["repos/T-ej2003/genuine-scan-main/branches/main", "repos/T-ej2003/genuine-scan-main/actions/runs/123", "repos/T-ej2003/genuine-scan-main/actions/artifacts/456/zip"]) assert.throws(() => run("gh", ["api", endpoint, "--paginate", "--slurp"]), /reviewed read-only/);
  for (const flags of [["--slurp", "--paginate"], ["--paginate"], ["--slurp"], ["--paginate", "--slurp", "--paginate"]]) assert.throws(() => run("gh", ["api", "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts?per_page=100", ...flags]), /reviewed read-only/);
  assert.throws(() => run("gh", ["api", "repos/example/repository"]), /reviewed read-only/);
  for (const endpoint of [
    "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts?per_page=99",
    "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts?per_page=101",
    "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts?page=2",
    "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts?foo=bar",
    "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts?per_page=100&foo=bar",
    "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts?foo=bar&per_page=100",
    "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts?per_page=100&per_page=100",
    "repos/T-ej2003/genuine-scan-main/actions/runs/0/artifacts?per_page=100",
    "repos/T-ej2003/genuine-scan-main/actions/runs/-1/artifacts?per_page=100",
    "repos/T-ej2003/genuine-scan-main/actions/runs/not-a-run/artifacts?per_page=100",
    "repos/other/repository/actions/runs/123/artifacts?per_page=100",
    "repos/T-ej2003/genuine-scan-main/actions/runs/123%2f..%2f456/artifacts?per_page=100",
    "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts%3fper_page=100",
    "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts?per_page%3d100",
    "repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts?per_page=100#fragment",
    "https://api.github.com/repos/T-ej2003/genuine-scan-main/actions/runs/123/artifacts?per_page=100",
    "repos/T-ej2003/genuine-scan-main/actions/workflows/other.yml/runs?branch=main&event=workflow_dispatch&status=success&per_page=100",
    "repos/T-ej2003/genuine-scan-main/actions/workflows/produce-production-app-only-requirements.yml/runs?branch=other&event=workflow_dispatch&status=success&per_page=100",
    "repos/T-ej2003/genuine-scan-main/actions/workflows/produce-production-app-only-requirements.yml/runs?branch=main&event=push&status=success&per_page=100",
    "repos/T-ej2003/genuine-scan-main/actions/workflows/produce-production-app-only-requirements.yml/runs?branch=main&event=workflow_dispatch&status=failure&per_page=100",
  ]) assert.throws(() => run("gh", ["api", endpoint]), /reviewed read-only/);
...
test("every GitHub workflow credential root is classified by its authenticated mode", () => {
  const oidcWorkflows = [
    ...
    ".github/workflows/bootstrap-production-component-deployment-state.yml",
    ".github/workflows/auto-failover-monitor.yml", ".github/workflows/authorize-production-initial-activation-lifecycle-policy-reconciliation.yml", ".github/workflows/authorize-production-initial-activation-policy-reconciler-installation.yml", ".github/workflows/authorize-production-stage-a-production-artifacts-continuation-rebind.yml", ".github/workflows/authorize-production-stage-a-production-artifacts-reconciliation.yml", ".github/workflows/aws-dr-alb-apply.yml", ".github/workflows/aws-dr-cleanup-apply.yml", ".github/workflows/aws-dr-db-apply.yml", ".github/workflows/aws-dr-dns-apply.yml", ".github/workflows/aws-dr-hardening-apply.yml", ".github/workflows/aws-dr-object-storage-apply.yml", ".github/workflows/aws-dr-operations.yml", ".github/workflows/aws-dr-regional-readiness.yml", ".github/workflows/aws-dr-snapshot-apply.yml", ".github/workflows/execute-production-green-stage-b-state-reconciliation.yml", ".github/workflows/execute-production-initial-activation-exact-complete-state-reconciliation.yml", ".github/workflows/execute-production-initial-activation-exact-complete-state-reconciliation-recovery.yml", ".github/workflows/execute-production-initial-activation-reconciler-state-reconciliation.yml", ".github/workflows/execute-production-initial-activation-reconciler-state-reconciliation-recovery.yml", ".github/workflows/execute-production-mixed-dual-slot-topology-recovery.yml", ".github/workflows/execute-production-provider-readonly-policy-reconciliation.yml", ".github/workflows/prepare-production-green-stage-b-state-reconciliation.yml", ".github/workflows/production-green-backend-image-publish.yml", ".github/workflows/production-green-stage-b-image-build.yml", ".github/workflows/production-web-activation.yml", ".github/workflows/production-web-image.yml", ".github/workflows/release-gate.yml", ".github/workflows/staging-terraform-remote-state-drift.yml",
  ];
...
test("every direct production AWS root declares its credential provenance before invoking AWS", () => {
  const roots = [
    ...
    ["scripts/aws/bootstrap-production-component-deployment-state.mjs", "GITHUB_OIDC_RELEASE_DEPLOYER"],
    ["scripts/aws/prepare-production-normal-deployment.mjs", "GITHUB_OIDC_RELEASE_DEPLOYER"],
    ["scripts/aws/commit-production-component-recovery-state.mjs", "GITHUB_OIDC_RELEASE_DEPLOYER"],
    ["scripts/aws/commit-production-component-security-state.mjs", "GITHUB_OIDC_RELEASE_DEPLOYER"],
    ["scripts/aws/commit-production-component-rotation-state.mjs", "GITHUB_OIDC_RELEASE_DEPLOYER"],
