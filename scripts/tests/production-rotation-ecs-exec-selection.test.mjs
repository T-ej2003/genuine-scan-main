...
const select = (tasks) => selectTargetTask({ tasks, expectedClusterArn: clusterArn, expectedTaskDefinitionArn: definitionArn, expectedImageDigest: digest, serviceName: "mscqr-backend-servi-euw2", containerName: "backend" });
