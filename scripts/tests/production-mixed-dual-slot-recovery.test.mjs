...
const iamPreflight = () => buildMixedDualSlotRecoveryIamPreflight({ sourceSha, principalArn: MIXED_DUAL_SLOT_RECOVERY_EXECUTION_ROLE_ARN, action: MIXED_DUAL_SLOT_RECOVERY_IAM_ACTION, resources: [...MIXED_DUAL_SLOT_RECOVERY_IAM_RESOURCES], resourcePolicies: MIXED_DUAL_SLOT_RECOVERY_IAM_RESOURCES.map((resource) => ({ resource, resourcePolicySha256: "74234e98afe7498fb5daf1f36ac2d78acc339464f950703b8c019892f982b90b", resourcePolicyAccess: "NO_RESOURCE_POLICY" })), evaluations: MIXED_DUAL_SLOT_RECOVERY_IAM_RESOURCES.map((resource) => ({ action: MIXED_DUAL_SLOT_RECOVERY_IAM_ACTION, resource, decision: "allowed", missingContextValues: [], organizationsAllowed: true, permissionsBoundaryAllowed: null })), observedAt: "2026-09-10T00:00:00.000Z" });
