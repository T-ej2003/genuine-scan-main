...
const input = { backendImage, releaseSha: sourceSha, backendLogGroup: "/ecs/mscqr-production/rls-green-backend", proxyTrust: { mode: "cloudfront-alb", albCidrs: "10.1.0.0/24", cloudFrontCidrs: "198.51.100.0/24" }, secretBindings };
