...
test("complete production dependency closure is exact across modes and failure paths", () => {
  ...
  assert.equal(report.newAwsCalls.length, 44 + stageAAdditions.length + 15 + 14 + 21 + 7 + 1 + 6 + 1 + 5 + 66); // Historical closure plus separately identity-mapped app-only calls.
